  ...
  [8458],
  {
    ...
    11419: (e, t, r) => {
      ...
      class c {
        ...
        parseError(e, t = this.url) {
          return (0, n.parseConnectionError)(e, o(t), "WS");
        }
        resetMaxListeners() {
        ...
        emitError(e) {
          let t = this.parseError(
            Error(
              e?.message ||
                `WebSocket connection failed for host: ${o(this.url)}`
            )
          );
    ...
    16616: (e, t, r) => {
      ...
      class b {
          ...
          this.indexedDb = (function (e = {}) {
            let t = {
              ...
              n = async () => {
                if (!t.watching)
                  for (let e in ((t.watching = !0), t.mounts))
                    t.unwatch[e] = await f(t.mounts[e], s, e);
              },
              o = async () => {
                if (t.watching) {
              ...
              m = {
                ...
                getItems: (e, t = {}) =>
                  y(e, t, (e) =>
                    e.driver.getItems
                      ...
                      : Promise.all(
                          e.items.map((t) =>
                            l(e.driver.getItem, t.relativeKey, t.options).then(
                              (e) => ({ key: t.key, value: a(e) })
                            )
                          )
                        )
                  ),
                getItemRaw(e, t = {}) {
                  ...
                  return s.getItemRaw
                    ...
                    : l(s.getItem, i, t).then((e) => {
                        var t;
                        return "string" == typeof e && e.startsWith(u)
                          ? ((t = e.slice(u.length)),
                            globalThis.Buffer
                              ? c.from(t, "base64")
                ...
                async setItem(e, t, i = {}) {
                  ...
                  o.setItem &&
                    (await l(o.setItem, n, h(t), i), o.watch || s("update", e));
                },
                async setItems(e, t) {
                  await y(e, t, async (e) => {
                ...
                async setItemRaw(e, t, i = {}) {
                  if (void 0 === t) return m.removeItem(e, i);
                  let { relativeKey: n, driver: o } = r((e = d(e)));
                ...
                async getMeta(e, t = {}) {
                  ...
                  if (
                    (s.getMeta && Object.assign(n, await l(s.getMeta, i, t)),
                    !t.nativeOnly)
                  ) {
                ...
                async getKeys(e, t = {}) {
                  ...
                  for (let e of r) {
                    ...
                    await l(e.driver.getKeys, e.relativeBase, t))) {
            ...
            driver: ((e = {}) => {
              ...
              return (
                e.dbName &&
                  e.storeName &&
                  (t = (0, y.y$)(e.dbName, e.storeName)),
                {
                  name: "idb-keyval",
                  options: e,
                  hasItem: async (e) =>
                    !(typeof (await (0, y.Jt)(r + e, t)) > "u"),
                  getItem: async (e) => (await (0, y.Jt)(r + e, t)) ?? null,
                  setItem: (e, i) => (0, y.hZ)(r + e, i, t),
                  removeItem: (e) => (0, y.yH)(r + e, t),
                  getKeys: () => (0, y.HP)(t),
                  clear: () => (0, y.IU)(t),
                }
              );
        ...
        async setItem(e, t) {
          await this.indexedDb.setItem(e, (0, m.h)(t));
        }
        async removeItem(e) {
      ...
      !(function () {
        ...
        (e.prototype.getItem = function (e) {
          ...
          "u" > typeof w && w.localStorage
            ? (v.exports = w.localStorage)
            : "u" > typeof window && window.localStorage
            ? (v.exports = window.localStorage)
            : (v.exports = new e());
      })();
      class I {
        constructor() {
          this.localStorage = v.exports;
        }
        async getKeys() {
          return Object.keys(this.localStorage);
        }
        async getEntries() {
          return Object.entries(this.localStorage).map(E);
        }
        async getItem(e) {
          let t = this.localStorage.getItem(e);
          if (null !== t) return (0, m.j)(t);
        }
        async setItem(e, t) {
          this.localStorage.setItem(e, (0, m.h)(t));
        }
        async removeItem(e) {
    ...
    20852: (e, t, r) => {
      ...
      function X(e, t) {
        ...
        if (t <= H) throw Error("invert: expected positive modulus, got " + t);
        let r = Z(e, t),
          i = t,
          s = H,
          n = V;
      ...
      function er(e, t, r = !1, i = {}) {
        let s;
        if (e <= H) throw Error("invalid field: expected ORDER > 0, got " + e);
        let { nBitLength: n, nByteLength: o } = et(e, t);
        if (o > 2048)
        ...
        let a = Object.freeze({
          ...
          pow: (e, t) =>
            (function (e, t, r) {
              if (r < H) throw Error("invalid exponent, negatives unsupported");
              if (r === H) return e.ONE;
              if (r === V) return t;
              let i = e.ONE,
                s = t;
                  ...
                  return (function (e) {
                    ...
                    for (
                      ...
                      (function (e, t, r) {
                        ...
                        if (r <= H) throw Error("invalid modulus");
                        if (r === V) return H;
                        let i = V;
                        for (; t > H; )
                          t & V && (i = (i * e) % r),
      ...
      function ea(e, t) {
        return (
          eo(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
        );
      }
      let ec = new WeakMap(),
        el = new WeakMap();
        ...
        e_ = (function (e) {
          ...
          let b = F((e, t) => {
              let { ex: r, ey: s, ez: n } = e,
                o = e.is0();
              null == t && (t = o ? ef : i.inv(n));
              let a = u(r * t),
                c = u(s * t),
                l = u(n * t);
              if (o) return { x: eu, y: ed };
              if (l !== ed) throw Error("invZ was invalid");
              return { x: a, y: c };
            }),
            w = F((e) => {
              let { a: t, d: i } = r;
          ...
          class v {
            ...
            static fromAffine(e) {
              ...
              let { x: t, y: r } = e || {};
              return y("x", t), y("y", r), new v(t, r, ed, u(t * r));
            }
            static normalizeZ(e) {
            ...
            clearCofactor() {
              let { h: e } = r;
              return e === ed ? this : this.multiplyUnsafe(e);
            }
            static fromHex(e, t = !1) {
              ...
              a[o - 1] = -129 & c;
              let l = j(a);
              $("pointHex.y", l, eu, t ? h : i.ORDER);
              let d = u(l * l),
                { isValid: f, value: g } = p(u(d - ed), u(s * d - n));
            ...
            toRawBytes() {
              let { x: e, y: t } = this.toAffine(),
                r = L(t, i.BYTES);
              return (r[r.length - 1] |= e & ed ? 128 : 0), r;
            }
            toHex() {
              return A(this.toRawBytes());
            }
          }
          (v.BASE = new v(r.Gx, r.Gy, ed, u(r.Gx * r.Gy))),
            (v.ZERO = new v(eu, ed, ed, eu));
          let { BASE: E, ZERO: x } = v,
            D =
              ((t = 8 * c),
              {
                ...
                unsafeLadder(e, t, r = v.ZERO) {
                  let i = e;
                  for (; t > ei; )
                    t & es && (r = r.add(i)), (i = i.double()), (t >>= es);
                  return r;
                },
                precomputeWindow(e, r) {
                  let { windows: i, windowSize: s } = ea(r, t),
                    n = [],
                    o = e,
                    a = o;
                  for (let e = 0; e < i; e++) {
                ...
                wNAF(e, r, i) {
                  let { windows: s, windowSize: n } = ea(e, t),
                    o = v.ZERO,
                    a = v.BASE,
                    c = BigInt(2 ** e - 1),
                    l = 2 ** e,
                ...
                wNAFUnsafe(e, r, i, s = v.ZERO) {
                  let { windows: n, windowSize: o } = ea(e, t),
                    a = BigInt(2 ** e - 1),
                    c = 2 ** e,
                    l = BigInt(e);
                  for (let e = 0; e < n; e++) {
          ...
          function O(e = new Uint8Array(), ...t) {
            return Z(j(o(g(q(...t), k("context", e), !!n))), s);
          }
          return (
            E._setWindowSize(8),
            {
              ...
              sign: function (e, t, r = {}) {
                ...
                let { prefix: o, scalar: a, pointBytes: c } = P(t),
                  ...
                  u = Z(l + O(r.context, h, c, e) * a, s);
                return (
                  $("signature.s", u, eu, s),
                  k("result", q(h, L(u, i.BYTES)), 2 * i.BYTES)
                );
              },
              verify: function (e, t, r, s = eg) {
                let o,
                  a,
                  c,
            ...
            let r = Z(t * t * t, ey),
              i = (function (e) {
                let t = BigInt(10),
                  ...
                  p = (Q(d, s, ey) * u) % ey,
                  f = (Q(p, t, ey) * c) % ey;
                return { pow_p_5_8: (Q(f, ew, ey) * e) % ey, b2: n };
              })(e * Z(r * r * t, ey)).pow_p_5_8,
              s = Z(e * r * i, ey),
              n = Z(t * s * s, ey),
              o = s,
              a = Z(s * em, ey),
      ...
      function eA(e = 0) {
        return null != globalThis.Buffer &&
          ...
          ? eO(globalThis.Buffer.allocUnsafe(e))
          : new Uint8Array(e);
      }
      function eC(e, t) {
      ...
      class ek {
        constructor(e, t, r, i) {
          (this.name = e),
            ...
            (this.baseEncode = r),
            (this.baseDecode = i),
            (this.encoder = new eN(e, t, r)),
            (this.decoder = new ej(e, t, i));
        }
        encode(e) {
      ...
      let eq = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new ek(e, t, r, i),
        eB = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: s } = eR(r, t);
          return eq({ prefix: e, name: t, encode: i, decode: (e) => eT(s(e)) });
        },
        e$ = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
          eq({
            prefix: t,
            name: e,
            encode: (e) =>
      ...
      var eM = Object.freeze({
        ...
        eH = Object.freeze({
          __proto__: null,
          base10: eB({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        }),
        eV = Object.freeze({
          __proto__: null,
          base16: e$({
      ...
      let e5 = Array.from(
        ...
        e6 = e5.reduce((e, t, r) => ((e[r] = t), e), []),
        e4 = e5.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []);
      var e9 = Object.freeze({
        ...
        base256emoji: eq({
          ...
          name: "base256emoji",
          encode: function (e) {
            return e.reduce((e, t) => (e += e6[t]), "");
          },
          decode: function (e) {
            let t = [];
            for (let r of e) {
              let e = e4[r.codePointAt(0)];
      ...
      function e7(e, t, r) {
        ...
        return (t[r] = 0 | e), (e7.bytes = r - i + 1), t;
      }
      var te = {
        encode: e7,
      ...
      let tt = (e, t, r = 0) => (te.encode(e, t, r), t),
        tr = (e) => te.encodingLength(e),
        ti = (e, t) => {
          let r = t.byteLength,
            i = tr(e),
            s = i + tr(r),
            n = new Uint8Array(s + r);
          return tt(e, n, 0), tt(r, n, i), n.set(t, s), new ts(e, r, t, n);
        };
      class ts {
        constructor(e, t, r, i) {
      ...
      let tn = ({ name: e, code: t, encode: r }) => new to(e, t, r);
      class to {
        constructor(e, t, r) {
      ...
      var tc = Object.freeze({
          __proto__: null,
          sha256: tn({ name: "sha2-256", code: 18, encode: ta("SHA-256") }),
          sha512: tn({ name: "sha2-512", code: 19, encode: ta("SHA-512") }),
        }),
        tl = Object.freeze({
          __proto__: null,
          identity: {
      ...
      let td = tu(
        ...
        tp = tu(
          ...
          (e) => {
            let t = eA((e = e.substring(1)).length);
      ...
      function ty(e, t = "utf8") {
        ...
        return ("utf8" === t || "utf-8" === t) &&
          null != globalThis.Buffer &&
          null != globalThis.Buffer.from
          ? eO(globalThis.Buffer.from(e, "utf-8"))
          : r.decoder.decode(`${r.prefix}${e}`);
      }
      function tm(e) {
        return (0, s.j)(tg(ty(e, ex), eD));
      }
      function tb(e) {
        return tg(ty((0, s.h)(e), eD), ex);
      }
      function tw(e) {
        return ["did:key", "z" + tg(eC([ty("K36", eS), e]), eS)].join(":");
      }
      function tv(e) {
        let t = e.split("."),
          r = tm(t[0]),
        ...
        return {
          ...
          payload: i,
          signature: ty(t[2], ex),
          data: ty(t.slice(0, 2).join("."), eP),
        };
      }
      function tE(e = u(32)) {
        let t = e_.getPublicKey(e);
        return { secretKey: eC([e, t]), publicKey: t };
      }
      async function tI(e, t, r, s, n = (0, i.fromMiliseconds)(Date.now())) {
        let o = { alg: "EdDSA", typ: "JWT" },
          a = { iss: tw(s.publicKey), sub: e, aud: t, iat: n, exp: n + r },
          c = ty(
            [tb((l = { header: o, payload: a }).header), tb(l.payload)].join(
              "."
            ),
            eP
          );
        var l,
          h = {
            header: o,
            payload: a,
            signature: e_.sign(c, s.secretKey.slice(0, 32)),
          };
        return [tb(h.header), tb(h.payload), tg(h.signature, ex)].join(".");
      }
    },
    22926: (e, t, r) => {
      "use strict";
    ...
    48458: (e, t, r) => {
      ...
      let j = [],
        ...
        M = BigInt(256),
        z = BigInt(113);
      for (let e = 0, t = q, r = 1, i = 0; e < 24; e++) {
        ([r, i] = [i, (2 * r + 3 * i) % 5]),
          j.push(2 * (5 * i + r)),
          U.push((((e + 1) * (e + 2)) / 2) % 64);
        let s = k;
      ...
      let Z = new Y(8192);
      async function Q({ hash: e, signature: t }) {
        let i = d(e) ? e : E(e),
          { secp256k1: s } = await r.e(5666).then(r.bind(r, 35666)),
          n = (() => {
      ...
      async function ee({ hash: e, signature: t }) {
        var r = await Q({ hash: e, signature: t });
        let i = G(`0x${r.substring(4)}`).substring(26);
        return (function (e, t) {
          if (Z.has(`${e}.undefined`)) return Z.get(`${e}.${void 0}`);
      ...
      var eh = Object.defineProperty,
        ...
        ey = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        em = (e, t) => {
          for (var r in t || (t = {})) ef.call(t, r) && ey(e, r, t[r]);
          if (ep) for (var r of ep(t)) eg.call(t, r) && ey(e, r, t[r]);
          return e;
        };
      let eb = {
      ...
      function ew() {
        return (
          "u" > typeof en &&
          "u" > typeof en.versions &&
          "u" > typeof en.versions.node
        );
      }
      function ev() {
        return (
      ...
      function eE() {
        return !ew() && !!(0, a.getNavigator)() && !!(0, a.getDocument)();
      }
      function eI() {
        return ev()
          ? eb.reactNative
      ...
      function eA(e = o.FIVE_MINUTES, t) {
        let r,
          i,
          s,
          n,
          ...
          let l = (function (e, t, r) {
              ...
              if (e.startsWith("https://t.me")) {
                ...
                s = `${s}${t}${(function (e, t = !1) {
                  let r = eo.from(e).toString("base64");
      ...
      async function eq(e, t) {
        let r = "";
        try {
          if (eE() && (r = localStorage.getItem(t))) return r;
          r = await e.getItem(t);
        } catch (e) {
          console.error(e);
        }
      ...
      function eM() {
        return "u" > typeof en && "true" === en.env.IS_VITEST;
      }
      function ez(e) {
        return eo.from(e, "base64").toString("utf-8");
      }
      function eF(e) {
      ...
      let eX = 68 === new Uint8Array(new Uint32Array([0x11223344]).buffer)[0];
      function e0(e) {
        for (let r = 0; r < e.length; r++) {
          var t;
          e[r] =
      ...
      function e3(e = 32) {
        if (eY && "function" == typeof eY.getRandomValues)
          return eY.getRandomValues(new Uint8Array(e));
        if (eY && "function" == typeof eY.randomBytes) return eY.randomBytes(e);
        throw Error("crypto.getRandomValues must be defined");
      }
      let e5 = [],
        e6 = [],
        ...
        tr = BigInt(256),
        ti = BigInt(113);
      for (let e = 0, t = e7, r = 1, i = 0; e < 24; e++) {
        ([r, i] = [i, (2 * r + 3 * i) % 5]),
          e5.push(2 * (5 * i + r)),
          e6.push((((e + 1) * (e + 2)) / 2) % 64);
        let s = e9;
        for (let e = 0; e < 7; e++)
          (t = ((t << e7) ^ ((t >> tt) * ti)) % tr) & te &&
            (s ^= e7 << ((e7 << BigInt(e)) - e7));
        e4.push(s);
      }
      let [ts, tn] = (function (e, t = !1) {
          let r = new Uint32Array(e.length),
            i = new Uint32Array(e.length);
          for (let s = 0; s < e.length; s++) {
            let { h: n, l: o } = (function (e, t = !1) {
              return t
                ? { h: Number(e & eJ), l: Number((e >> eG) & eJ) }
                : { h: 0 | Number((e >> eG) & eJ), l: 0 | Number(e & eJ) };
            })(e[s], t);
            [r[s], i[s]] = [n, o];
          }
          return [r, i];
      ...
      let tl = e8(() => new tc(136, 1, 32));
      function th(e) {
        let t = `Ethereum Signed Message:
${e.length}`,
          r = new TextEncoder().encode(t + e);
        return "0x" + eo.from(tl(r)).toString("hex");
      }
      async function tu(e, t, r, i, s, n) {
        switch (r.t) {
          case "eip191":
            return await td(e, t, r.s);
          case "eip1271":
            return await tp(e, t, r.s, i, s, n);
          default:
            throw Error(
      ...
      async function td(e, t, r) {
        return (
          (await ee({ hash: th(t), signature: r })).toLowerCase() ===
          e.toLowerCase()
        );
      }
      async function tp(e, t, r, i, s, n) {
        let o = ea(i);
      ...
      async function tx(e) {
        let { cacao: t, projectId: r } = e,
          ...
          n = tD(s, s.iss),
          o = t_(s.iss);
        return await tu(o, n, i, tI(s.iss), r);
      }
      let tD = (e, t) => {
...
`)
      ...
      function tO(e) {
        ...
        let r =
          ...
          JSON.parse(eo.from(t, "base64").toString("utf-8")));
        return tP(r), r;
      }
      function tA(e) {
        var t;
      ...
      function tj(e, ...t) {
        if (!tN(e)) throw Error("Uint8Array expected");
        if (t.length > 0 && !t.includes(e.length))
          throw Error(
            "Uint8Array expected of length " + t + ", got length=" + e.length
          );
      ...
      let tF = (e) => Uint8Array.from(e.split("").map((e) => e.charCodeAt(0))),
        tH = tF("expand 16-byte k"),
        tV = tF("expand 32-byte k"),
        tK = tk(tH),
        tW = tk(tV);
      function tJ(e, t) {
        return (e << t) | (e >>> (32 - t));
      ...
      let tY = 0x100000000 - 1,
        tZ = new Uint32Array(),
        tQ = (e, t) => (255 & e[t++]) | ((255 & e[t++]) << 8);
      class tX {
        constructor(e) {
          (this.blockLen = 16),
            (this.outputLen = 16),
          ...
          (this.r[0] = 8191 & t),
            ...
            (this.r[9] = (c >>> 5) & 127);
          for (let t = 0; t < 8; t++) this.pad[t] = tQ(e, 16 + 2 * t);
        }
        process(e, t, r = !1) {
          let { h: i, r: s } = this,
            n = s[0],
        ...
        destroy() {
          tz(this.h, this.r, this.buffer, this.pad);
        }
        digestInto(e) {
          tU(this),
            (function (e, t) {
      ...
      let t0 = (function (e) {
        ...
        t1 = (function (e, t) {
          ...
          return (
            ...
            (t, a, c, l, h = 0) => {
              ...
              if (i) {
                ...
                i(g, y, tk(a.subarray(0, 16)), y), (a = a.subarray(16));
              }
              let m = 16 - s;
              if (m !== a.length)
          ...
          function (e, t, r, i, s, n = 20) {
            let o = e[0],
              ...
              L = v;
            for (let e = 0; e < n; e += 2)
              (A = (A + (N = tJ(N ^ (E = (E + D) | 0), 16))) | 0),
                (E = (E + (D = tJ(D ^ A, 12))) | 0),
                (A = (A + (N = tJ(N ^ E, 8))) | 0),
                (D = tJ(D ^ A, 7)),
                (C = (C + (j = tJ(j ^ (I = (I + P) | 0), 16))) | 0),
                (I = (I + (P = tJ(P ^ C, 12))) | 0),
                (C = (C + (j = tJ(j ^ I, 8))) | 0),
                (P = tJ(P ^ C, 7)),
                (R = (R + (U = tJ(U ^ (_ = (_ + S) | 0), 16))) | 0),
                (_ = (_ + (S = tJ(S ^ R, 12))) | 0),
                (R = (R + (U = tJ(U ^ _, 8))) | 0),
                (S = tJ(S ^ R, 7)),
                (T = (T + (L = tJ(L ^ (x = (x + O) | 0), 16))) | 0),
                (x = (x + (O = tJ(O ^ T, 12))) | 0),
                (T = (T + (L = tJ(L ^ x, 8))) | 0),
                (O = tJ(O ^ T, 7)),
                (R = (R + (L = tJ(L ^ (E = (E + P) | 0), 16))) | 0),
                (E = (E + (P = tJ(P ^ R, 12))) | 0),
                (R = (R + (L = tJ(L ^ E, 8))) | 0),
                (P = tJ(P ^ R, 7)),
                (T = (T + (N = tJ(N ^ (I = (I + S) | 0), 16))) | 0),
                (I = (I + (S = tJ(S ^ T, 12))) | 0),
                (T = (T + (N = tJ(N ^ I, 8))) | 0),
                (S = tJ(S ^ T, 7)),
                (A = (A + (j = tJ(j ^ (_ = (_ + O) | 0), 16))) | 0),
                (_ = (_ + (O = tJ(O ^ A, 12))) | 0),
                (A = (A + (j = tJ(j ^ _, 8))) | 0),
                (O = tJ(O ^ A, 7)),
                (C = (C + (U = tJ(U ^ (x = (x + D) | 0), 16))) | 0),
                (x = (x + (D = tJ(D ^ C, 12))) | 0),
                (C = (C + (U = tJ(U ^ x, 8))) | 0),
                (D = tJ(D ^ C, 7));
            let k = 0;
        ...
        t8 = (e, t) => {
          e.update(t);
          let r = t.length % 16;
          r && e.update(t2.subarray(r));
        },
        t3 = new Uint8Array(32);
      function t5(e, t, r, i, s) {
        ...
        t$(c, 0, BigInt(s ? s.length : 0), !0),
          t$(c, 8, BigInt(i.length), !0),
          o.update(a);
        let l = o.digest();
        return tz(n, a), l;
      }
      let t6 = ((e, t) => {
        function r(i, ...s) {
          if ((tj(i), void 0 !== e.nonceLength)) {
            let t = s[0];
            if (!t) throw Error("nonce / iv required");
            e.varSizeNonce ? tj(t) : tj(t, e.nonceLength);
          }
          let n = e.tagLength;
          n && void 0 !== s[1] && tj(s[1]);
          let o = t(i, ...s),
          ...
          return {
            encrypt(e, t) {
              ...
              return (c = !0), tj(e), a(o.encrypt.length, t), o.encrypt(e, t);
            },
            decrypt(e, t) {
              if ((tj(e), n && e.length < n))
                throw Error(
        ...
        ((e) => (t, r, i) => ({
          encrypt(s, n) {
            ...
            e(t, r, a, a, 1);
            let c = t5(e, t, r, a, i);
            return n.set(c, o), tz(c), n;
          },
          decrypt(s, n) {
            n = tB(s.length - 16, n, !1);
            ...
            return n.set(s.subarray(0, -16)), e(t, r, n, n, 1), tz(c), n;
          },
        }))(t1)
      );
      class t4 extends e2 {
      ...
      let t9 = (e, t, r) => new t4(e, t).update(r).digest();
      ...
      class rt extends e2 {
        ...
        digestInto(e) {
          eK(this), eW(e, this), (this.finished = !0);
          let { buffer: t, view: r, blockLen: i, isLE: s } = this,
            { pos: n } = this;
          (t[n++] = 128),
      ...
      class rn extends rt {
        ...
        process(e, t) {
          for (let r = 0; r < 16; r++, t += 4) rs[r] = e.getUint32(t, !1);
          for (let e = 16; e < 64; e++) {
            let t = rs[e - 15],
              r = rs[e - 2],
              i = eQ(t, 7) ^ eQ(t, 18) ^ (t >>> 3),
              s = eQ(r, 17) ^ eQ(r, 19) ^ (r >>> 10);
            rs[e] = (s + rs[e - 7] + i + rs[e - 16]) | 0;
          }
          ...
          for (let e = 0; e < 64; e++) {
            ...
            let t =
                (l +
                  (eQ(o, 6) ^ eQ(o, 11) ^ eQ(o, 25)) +
                  (((h = o) & a) ^ (~h & c)) +
                  rr[e] +
                  rs[e]) |
                0,
              f =
                ((eQ(r, 2) ^ eQ(r, 13) ^ eQ(r, 22)) +
                  (((u = r) & (d = i)) ^ (u & (p = s)) ^ (d & p))) |
                0;
            (l = c),
              (c = a),
      ...
      function ru(e) {
        if (!rh(e)) throw Error("Uint8Array expected");
      }
      function rd(e, t) {
        if ("boolean" != typeof t)
          throw Error(e + " boolean expected, got " + t);
      }
      let rp = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, "0")
      );
      function rf(e) {
        ru(e);
        let t = "";
        for (let r = 0; r < e.length; r++) t += rp[e[r]];
        return t;
      }
      function rg(e) {
        let t = e.toString(16);
      ...
      function ry(e) {
        if ("string" != typeof e)
          throw Error("hex string expected, got " + typeof e);
        return "" === e ? ra : BigInt("0x" + e);
      }
      let rm = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
      function rb(e) {
        return e >= rm._0 && e <= rm._9
          ? e - rm._0
          : e >= rm.A && e <= rm.F
          ? e - (rm.A - 10)
          : e >= rm.a && e <= rm.f
      ...
      function rw(e) {
        ...
        let i = new Uint8Array(r);
        for (let t = 0, s = 0; t < r; t++, s += 2) {
          let r = rb(e.charCodeAt(s)),
            n = rb(e.charCodeAt(s + 1));
          if (void 0 === r || void 0 === n)
            throw Error(
              'hex string expected, got non-hex character "' +
                (e[s] + e[s + 1]) +
      ...
      function rE(e) {
        return ru(e), ry(rf(Uint8Array.from(e).reverse()));
      }
      function rI(e, t) {
        return rw(e.toString(16).padStart(2 * t, "0"));
      }
      function r_(e, t) {
      ...
      function rx(e, t, r) {
        ...
        else if (rh(t)) i = Uint8Array.from(t);
        else throw Error(e + " must be hex string or Uint8Array");
        let s = i.length;
        if ("number" == typeof r && s !== r)
          throw Error(e + " of length " + r + " expected, got " + s);
      ...
      let rP = (e) => "bigint" == typeof e && ra <= e;
      function rS(e, t, r) {
        return rP(e) && rP(t) && rP(r) && t <= e && e < r;
      }
      function rO(e, t, r, i) {
        if (!rS(t, r, i))
          throw Error(
      ...
      function rA(e) {
        let t;
        for (t = 0; e > ra; e >>= rc, t += 1);
        return t;
      }
      let rC = (e) => (rl << BigInt(e - 1)) - rc,
        rR = (e) => new Uint8Array(e),
        rT = (e) => Uint8Array.from(e);
      function rN(e, t, r) {
      ...
      let rj = {
        ...
        boolean: (e) => "boolean" == typeof e,
        string: (e) => "string" == typeof e,
        stringOrUint8Array: (e) => "string" == typeof e || rh(e),
        isSafeInteger: (e) => Number.isSafeInteger(e),
        array: (e) => Array.isArray(e),
        field: (e, t) => t.Fp.isValid(e),
        hash: (e) =>
      ...
      var rk = Object.freeze({
        ...
        bitLen: rA,
        bitGet: function (e, t) {
          return (e >> BigInt(t)) & rc;
        },
        bitSet: function (e, t, r) {
          return e | ((r ? rc : ra) << BigInt(t));
        },
        bitMask: rC,
        createHmacDrbg: rN,
        validateObject: rU,
      ...
      function rK(e, t, r) {
        if (t < rq) throw Error("invalid exponent, negatives unsupported");
        if (r <= rq) throw Error("invalid modulus");
        if (r === rB) return rq;
        let i = rB;
        for (; t > rq; )
          t & rB && (i = (i * e) % r), (e = (e * e) % r), (t >>= rB);
        return i;
      }
      function rW(e, t, r) {
        let i = e;
      ...
      function rJ(e, t) {
        if (e === rq) throw Error("invert: expected non-zero number");
        if (t <= rq) throw Error("invert: expected positive modulus, got " + t);
        let r = rV(e, t),
          i = t,
          s = rq,
          n = rB;
        ...
        if (i !== rB) throw Error("invert: does not exist");
        return rV(s, t);
      }
      let rG = [
        "create",
      ...
      function rZ(e, t, r = !1, i = {}) {
        let s;
        if (e <= rq) throw Error("invalid field: expected ORDER > 0, got " + e);
        let { nBitLength: n, nByteLength: o } = rY(e, t);
        if (o > 2048)
          throw Error("invalid field: expected ORDER of <= 2048 bytes");
        let a = Object.freeze({
          ORDER: e,
          ...
          pow: (e, t) =>
            (function (e, t, r) {
              ...
              if (r === rq) return e.ONE;
              if (r === rB) return t;
              let i = e.ONE,
                s = t;
              for (; r > rq; )
                r & rB && (i = e.mul(i, s)), (s = e.sqr(s)), (r >>= rB);
              return i;
            })(a, e, t),
          div: (t, r) => rV(t * rJ(r, e), e),
          sqrN: (e) => e * e,
          addN: (e, t) => e + t,
          subN: (e, t) => e - t,
          mulN: (e, t) => e * t,
                ...
                (s = (function (e) {
                  ...
                  return (function (e) {
                    let t,
                      ...
                      i,
                      s = (e - rB) / r$;
                    for (t = e - rB, r = 0; t % r$ === rq; t /= r$, r++);
                    for (i = r$; i < e && rK(i, s, e) !== e - rB; i++)
                      if (i > 1e3)
                        throw Error(
                          "Cannot find square root: likely non-prime P"
                        );
      ...
      function r3(e, t) {
        return (
          r8(e, t), { windows: Math.ceil(t / e) + 1, windowSize: 2 ** (e - 1) }
        );
      }
      let r5 = new WeakMap(),
        r6 = new WeakMap();
      ...
      function r9(e) {
        return (
          ...
          Object.freeze({ ...rY(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
        );
      }
      ...
      let ia = (function (e) {
        let t =
          ...
          c = t.powPminus2 || ((e) => rK(e, r - BigInt(2), r));
        function l(e, t, r) {
          let s = i(e * (t - r));
        ...
        function u(e, t) {
          let u = (function (e, t) {
            ...
            (function (e) {
              let t = rx("u coordinate", e, n);
              return 32 === o && (t[31] &= 127), rE(t);
            })(t),
            (function (e) {
              let t = rx("scalar", e),
                r = t.length;
          ...
          if (u === r7) throw Error("invalid private or public key received");
          return r_(i(u), n);
        }
        let d = r_(i(t.Gu), n);
        function p(e) {
        ...
        powPminus2: (e) => {
          let { pow_p_5_8: t, b2: r } = (function (e) {
            let t = BigInt(10),
              ...
              p = (rW(d, s, it) * u) % it,
              f = (rW(p, t, it) * c) % it;
            return { pow_p_5_8: (rW(f, ii, it) * e) % it, b2: n };
          })(e);
          return rV(rW(t, is, it) * r, it);
        },
        adjustScalarBytes: function (e) {
          return (e[0] &= 248), (e[31] &= 127), (e[31] |= 64), e;
        },
      ...
      function ic(e) {
        void 0 !== e.lowS && rd("lowS", e.lowS),
          void 0 !== e.prehash && rd("prehash", e.prehash);
      }
      let { bytesToNumberBE: il, hexToBytes: ih } = rk;
      ...
      let id = {
          ...
          toSig(e) {
            let { Err: t, _int: r, _tlv: i } = id,
              s = "string" == typeof e ? ih(e) : e;
            ru(s);
            ...
            (function (e) {
              ...
              let {
                  ...
                  function c(e) {
                    ...
                    try {
                      t =
                        "bigint" == typeof e ? e : rv(rx("private key", e, s));
                    } catch {
                      throw Error(
                    ...
                    return n && (t = rV(t, o)), rO("private key", t, ig, o), t;
                  }
                  function l(e) {
                    if (!(e instanceof d))
                  ...
                  class d {
                    ...
                    static fromHex(e) {
                      let t = d.fromAffine(o(rx("pointHex", e)));
                    ...
                    toHex(e = !0) {
                      return rd("isCompressed", e), rf(this.toRawBytes(e));
                    }
                  }
                  ...
                  let p = r.nBitLength,
                    f =
                      ((t = r.endo ? Math.ceil(p / 2) : p),
                      {
                        ...
                        precomputeWindow(e, r) {
                          let { windows: i, windowSize: s } = r3(r, t),
                            n = [],
                            o = e,
                            a = o;
                          for (let e = 0; e < i; e++) {
                        ...
                        wNAF(e, r, i) {
                          let { windows: s, windowSize: n } = r3(e, t),
                            o = d.ZERO,
                            a = d.BASE,
                            c = BigInt(2 ** e - 1),
                            l = 2 ** e,
                        ...
                        wNAFUnsafe(e, r, i, s = d.ZERO) {
                          let { windows: n, windowSize: o } = r3(e, t),
                            a = BigInt(2 ** e - 1),
                            c = 2 ** e,
                            l = BigInt(e);
                          for (let e = 0; e < n; e++) {
                  ...
                  toBytes(e, t, i) {
                    ...
                    return (
                      rd("isCompressed", i),
                      i
                        ? rD(Uint8Array.from([t.hasEvenY() ? 2 : 3]), n)
                        : rD(Uint8Array.from([4]), n, r.toBytes(s.y))
                    );
                  },
                  fromBytes(e) {
                    let t = e.length,
                ...
                u = (e) => rf(rI(e, t.nByteLength)),
                d = (e, t, r) => rv(e.slice(t, r));
              class p {
                constructor(e, t, r) {
                  (this.r = e),
                    (this.s = t),
                ...
                static fromCompact(e) {
                  let r = t.nByteLength;
                  return new p(
                    d((e = rx("compactSignature", e, 2 * r)), 0, r),
                    d(e, r, 2 * r)
                  );
                }
                static fromDER(e) {
                  let { r: t, s: r } = id.toSig(rx("DER", e));
                  return new p(t, r);
                }
                assertValidity() {
                  rO("r", this.r, ig, i), rO("s", this.s, ig, i);
                }
                addRecoveryBit(e) {
                ...
                toDERRawBytes() {
                  return rw(this.toDERHex());
                }
                toDERHex() {
                  return id.hexFromSig({ r: this.r, s: this.s });
                }
                toCompactRawBytes() {
                  return rw(this.toCompactHex());
                }
                toCompactHex() {
              ...
              function b(e) {
                return (
                  rO("num < 2^" + t.nBitLength, e, ip, m), rI(e, t.nByteLength)
                );
              }
                  ...
                  sign: function (e, s, n = w) {
                    let { seed: l, k2sig: u } = (function (e, s, n = w) {
                      ...
                      null == d && (d = !0),
                        (e = rx("msgHash", e)),
                        ic(n),
                        f && (e = rx("prehashed msgHash", l(e)));
                      let v = y(e),
                        E = c(s),
                        I = [b(E), b(v)];
                      if (null != m && !1 !== m) {
                        let e = !0 === m ? u(r.BYTES) : m;
                        I.push(rx("extraEntropy", e));
                      }
                      return {
                        seed: rD(...I),
                        k2sig: function (e) {
                          ...
                          let l = o(s * o(v + c * E));
                          if (l === ip) return;
                          let u = (2 * (n.x !== c)) | Number(n.y & ig),
                            f = l;
                          return (
                            d &&
                              l > i >> ig &&
                              ((f = (t = l) > i >> ig ? o(-t) : t), (u ^= 1)),
                            new p(c, f, u)
                          );
                        },
                      };
                    })(e, s, n);
                    return rN(t.hash.outputLen, t.nByteLength, t.hmac)(l, u);
                  },
                  verify: function (e, r, s, n = v) {
                    let c, l;
                    (r = rx("msgHash", r)), (s = rx("publicKey", s));
                    let { lowS: h, prehash: u, format: d } = n;
                    if ((ic(n), "strict" in n))
                      throw Error("options.strict was renamed to lowS");
                    if (void 0 !== d && "compact" !== d && "der" !== d)
                      throw Error("format must be compact or der");
                    let f = "string" == typeof e || rh(e),
                      g =
                        !f &&
                        !d &&
                        "object" == typeof e &&
                    ...
                    try {
                      if ((g && (c = new p(e.r, e.s)), f)) {
                        try {
                          ...
                          if (!(e instanceof id.Err)) throw e;
                        }
                  ...
                  utils: {
                    ...
                    randomPrivateKey: () => {
                      ...
                      return (function (e, t, r = !1) {
                        ...
                        let o = rV(r ? rE(e) : rv(e), t - rB) + rB;
                        return r ? r_(o, s) : rI(o, s);
                      })(t.randomBytes(e), t.n);
                    },
      ...
      function iD(e) {
        let t = ro((0, ei.sH)(e, iv));
        return (0, ei.dI)(t, iv);
      }
      function iP(e) {
        let t = ro((0, ei.sH)(e, i_));
        return (0, ei.dI)(t, iv);
      }
      function iS(e) {
        return (0, ei.sH)(`${e}`, iw);
      ...
      function iR(e) {
        if (2 === iO(e.type))
          return (0, ei.dI)((0, ei.xW)([e.type, e.sealed]), iE);
        if (1 === iO(e.type)) {
          if (typeof e.senderPublicKey > "u")
            throw Error("Missing sender public key for type 1 envelope");
          return (0, ei.dI)(
            (0, ei.xW)([e.type, e.senderPublicKey, e.iv, e.sealed]),
            iE
          );
        }
        return (0, ei.dI)((0, ei.xW)([e.type, e.iv, e.sealed]), iE);
      }
      function iT(e) {
        let t = (e.encoding || iE) === iI ? iC(e.encoded) : e.encoded,
          r = (0, ei.sH)(t, iE),
          i = r.slice(0, 1);
        if (1 === iO(i)) {
          let e = r.slice(1, 33),
        ...
        if (2 === iO(i)) return { type: i, sealed: r.slice(1), iv: e3(12) };
        let s = r.slice(1, 13);
      ...
      function iQ(e) {
        ...
        for (let [n, o] of Object.entries(e)) {
          let e = iY(n) ? [n] : o.chains,
            a = o.methods || [],
            c = o.events || [],
            l = iZ(n);
          s[l] = iJ(iW({}, s[l]), {
            chains: eL(e, null == (t = s[l]) ? void 0 : t.chains),
            methods: eL(a, null == (r = s[l]) ? void 0 : r.methods),
            events: eL(c, null == (i = s[l]) ? void 0 : i.events),
          });
        }
        return s;
      }
      ...
      function i2(e, t) {
        let { message: r, code: i } = i1[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function i8(e, t) {
        let { message: r, code: i } = i0[e];
        return { message: t ? `${r} ${t}` : r, code: i };
      }
      function i3(e, t) {
        return (
      ...
      function i4(e, t) {
        return !!(t && i6(e)) || ("string" == typeof e && !!e.trim().length);
      }
      function i9(e, t) {
        return !!(t && i6(e)) || ("number" == typeof e && !isNaN(e));
      }
      function i7(e) {
        return !!(i4(e, !1) && e.includes(":")) && 2 === e.split(":").length;
      }
      function se(e) {
        let t = !0;
        return (
          i3(e) ? e.length && (t = e.every((e) => i4(e, !1))) : (t = !1), t
        );
      }
      function st(e, t) {
        let r = null;
      ...
      async function sl() {
        if (ev() && "u" > typeof r.g && null != r.g && r.g.NetInfo) {
      ...
      class sI extends sg.H {
        constructor(e, t) {
          super(), (this.relayer = e), (this.logger = t);
        }
      }
      class s_ extends sg.H {
        constructor(e) {
          super();
        }
      }
      ...
      class sD extends sg.H {
        constructor(e, t) {
          super(), (this.relayer = e), (this.logger = t);
        }
      }
      class sP extends sg.H {
        constructor(e, t) {
      ...
      class sT {
        constructor(e) {
          (this.opts = e), sR(this, "protocol", "wc"), sR(this, "version", 2);
        }
      }
      i.EventEmitter;
      class sN {
      ...
      let s$ = "core",
        ...
        sz = { logger: "error" },
        sF = { database: ":memory:" },
        sH = "client_ed25519_seed",
        sV = o.ONE_DAY,
        sK = o.SIX_HOURS,
        sW = "wss://relay.walletconnect.org",
        sJ = {
        ...
        sY = "2.21.1",
        sZ = { link_mode: "link_mode", relay: "relay" },
        sQ = { inbound: "inbound", outbound: "outbound" },
        sX = "WALLETCONNECT_LINK_MODE_APPS",
        s0 = {
        ...
        s5 = "https://verify.walletconnect.org",
        s6 = `${s5}/v3`,
        s4 = ["https://verify.walletconnect.com", s5],
        s9 = {
      ...
      class nh {
        constructor(e, t, r, i) {
          (this.name = e),
            ...
            (this.baseEncode = r),
            (this.baseDecode = i),
            (this.encoder = new no(e, t, r)),
            (this.decoder = new na(e, t, i));
        }
        encode(e) {
          return this.encoder.encode(e);
        }
      ...
      let nu = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new nh(e, t, r, i),
        nd = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: s } = ns(r, t);
          return nu({ prefix: e, name: t, encode: i, decode: (e) => nn(s(e)) });
        },
        np = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
          nu({
            prefix: t,
            name: e,
            encode: (e) =>
      ...
      var nf = Object.freeze({
        ...
        nm = Object.freeze({
          __proto__: null,
          base10: nd({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        }),
        nb = Object.freeze({
          __proto__: null,
          base16: np({
      ...
      let nT = Array.from(
        ...
        nN = nT.reduce((e, t, r) => ((e[r] = t), e), []),
        nj = nT.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []);
      var nU = Object.freeze({
        ...
        base256emoji: nu({
          ...
          name: "base256emoji",
          encode: function (e) {
            return e.reduce((e, t) => (e += nN[t]), "");
          },
          decode: function (e) {
            let t = [];
            for (let r of e) {
              let e = nj[r.codePointAt(0)];
              if (void 0 === e) throw Error(`Non-base256emoji character: ${r}`);
              t.push(e);
            }
            return new Uint8Array(t);
      ...
      function nL(e, t, r) {
        ...
        for (var i = r; e >= 0x80000000; )
          (t[r++] = (255 & e) | 128), (e /= 128);
        for (; -128 & e; ) (t[r++] = (255 & e) | 128), (e >>>= 7);
        return (t[r] = 0 | e), (nL.bytes = r - i + 1), t;
      }
      var nk = {
        encode: nL,
        encodingLength: function (e) {
      ...
      let nq = (e, t, r = 0) => (nk.encode(e, t, r), t),
        nB = (e) => nk.encodingLength(e),
        n$ = (e, t) => {
          let r = t.byteLength,
            i = nB(e),
            s = i + nB(r),
            n = new Uint8Array(s + r);
          return nq(e, n, 0), nq(r, n, i), n.set(t, s), new nM(e, r, t, n);
        };
      class nM {
        constructor(e, t, r, i) {
          (this.code = e), (this.size = t), (this.digest = r), (this.bytes = i);
      ...
      let nz = ({ name: e, code: t, encode: r }) => new nF(e, t, r);
      class nF {
        constructor(e, t, r) {
          (this.name = e), (this.code = t), (this.encode = r);
        }
      ...
      var nV = Object.freeze({
          __proto__: null,
          sha256: nz({ name: "sha2-256", code: 18, encode: nH("SHA-256") }),
          sha512: nz({ name: "sha2-512", code: 19, encode: nH("SHA-512") }),
        }),
        nK = Object.freeze({
          __proto__: null,
          identity: {
      ...
      class n0 {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            nX(this, "keychain", new Map()),
            nX(this, "name", "keychain"),
            nX(this, "version", "0.3"),
            nX(this, "initialized", !1),
            nX(this, "storagePrefix", sM),
            nX(this, "init", async () => {
              if (!this.initialized) {
            ...
            (this.core = e),
            (this.logger = (0, sf.U5)(t, this.name));
        }
        get context() {
          return (0, sf.oI)(this.logger);
        }
        get storageKey() {
          return (
            this.storagePrefix +
        ...
        async setKeyChain(e) {
          await this.core.storage.setItem(this.storageKey, eS(e));
        }
        async getKeyChain() {
          let e = await this.core.storage.getItem(this.storageKey);
          return "u" > typeof e ? eO(e) : void 0;
        }
        async persist() {
        ...
        isInitialized() {
          if (!this.initialized) {
            let { message: e } = i2("NOT_INITIALIZED", this.name);
            throw Error(e);
          }
        }
      }
      ...
      class n8 {
        constructor(e, t, r) {
          (this.core = e),
            ...
            n2(this, "name", "crypto"),
            n2(this, "keychain"),
            n2(this, "randomSessionIdentifier", ix()),
            ...
            n2(this, "getClientId", async () => {
              this.isInitialized();
              let e = await this.getClientSeed(),
                t = er.TZ(e);
              return er.UF(t.publicKey);
            }),
            n2(this, "generateKeyPair", () => {
              this.isInitialized();
              let e = (function () {
                let e = ia.utils.randomPrivateKey(),
                  t = ia.getPublicKey(e);
                return {
                  privateKey: (0, ei.dI)(e, iv),
                  publicKey: (0, ei.dI)(t, iv),
                };
              })();
              return this.setPrivateKey(e.publicKey, e.privateKey);
            }),
            n2(this, "signJWT", async (e) => {
              this.isInitialized();
              let t = await this.getClientSeed(),
                r = er.TZ(t),
                i = this.randomSessionIdentifier;
              return await er.FA(i, e, sV, r);
            }),
            n2(this, "generateSharedKey", (e, t, r) => {
              this.isInitialized();
              let i = (function (e, t) {
                var r;
                let i,
                  s = ia.getSharedSecret((0, ei.sH)(e, iv), (0, ei.sH)(t, iv)),
                  n =
                    ((i = void 0),
                    (function (e, t, r, i = 32) {
                      ...
                      ((r = void 0),
                      eV(ro),
                      void 0 === r && (r = new Uint8Array(ro.outputLen)),
                      t9(ro, e1(r), e1(s))),
                      i,
                      32
                    ));
            ...
            n2(this, "setSymKey", async (e, t) => {
              this.isInitialized();
              let r = t || iD(e);
              return await this.keychain.set(r, e), r;
            }),
            n2(this, "deleteKeyPair", async (e) => {
              this.isInitialized(), await this.keychain.del(e);
            }),
            n2(this, "deleteSymKey", async (e) => {
              this.isInitialized(), await this.keychain.del(e);
            }),
            n2(this, "encode", async (e, t, r) => {
              this.isInitialized();
              let i = iN(r),
                s = (0, sj.h)(t);
              if (2 === i.type)
                return (function (e, t) {
                  let r = iS(2),
                    i = e3(12),
                    s = iR({ type: r, sealed: (0, ei.sH)(e, i_), iv: i });
                  return t === iI ? iA(s) : s;
                })(s, r?.encoding);
              if (ij(i)) {
              ...
              return (function (e) {
                let t = iS("u" > typeof e.type ? e.type : 0);
                if (1 === iO(t) && typeof e.senderPublicKey > "u")
                  throw Error("Missing sender public key for type 1 envelope");
                let r =
                    "u" > typeof e.senderPublicKey
                      ? (0, ei.sH)(e.senderPublicKey, iv)
                      : void 0,
                  i = "u" > typeof e.iv ? (0, ei.sH)(e.iv, iv) : e3(12),
                  s = iR({
                    type: t,
                    sealed: t6((0, ei.sH)(e.symKey, iv), i).encrypt(
                      (0, ei.sH)(e.message, i_)
                    ),
                    iv: i,
                    senderPublicKey: r,
                  });
                return e.encoding === iI ? iA(s) : s;
              })({
                type: o,
                symKey: n,
                message: s,
            ...
            n2(this, "decode", async (e, t, r) => {
              this.isInitialized();
              let i = (function (e, t) {
                let r = iT({ encoded: e, encoding: t?.encoding });
                return iN({
                  type: iO(r.type),
                  senderPublicKey:
                    "u" > typeof r.senderPublicKey
                      ? (0, ei.dI)(r.senderPublicKey, iv)
                      : void 0,
              ...
              if (2 === i.type) {
                let e = (function (e, t) {
                  let { sealed: r } = iT({ encoded: e, encoding: t });
                  return (0, ei.dI)(r, i_);
                })(t, r?.encoding);
                return (0, sj.j)(e);
              }
            ...
            n2(this, "getPayloadType", (e, t = iE) =>
              iO(iT({ encoded: e, encoding: t }).type)
            ),
            n2(this, "getPayloadSenderPublicKey", (e, t = iE) => {
              let r = iT({ encoded: e, encoding: t });
            ...
            (this.core = e),
            (this.logger = (0, sf.U5)(t, this.name)),
            (this.keychain = r || new n0(this.core, this.logger));
        }
        get context() {
          return (0, sf.oI)(this.logger);
        }
        ...
        async getClientSeed() {
          let e = "";
          try {
            e = this.keychain.get(sH);
          } catch {
            (e = ix()), await this.keychain.set(sH, e);
          }
      ...
      var n3 = Object.defineProperty,
        ...
        oe = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        ot = (e, t, r) => oe(e, "symbol" != typeof t ? t + "" : t, r);
      class or extends sE {
        constructor(e, t) {
          super(e, t),
            (this.logger = e),
            (this.core = t),
            ot(this, "messages", new Map()),
            ot(this, "messagesWithoutClientAck", new Map()),
            ot(this, "name", "messages"),
            ot(this, "version", "0.3"),
            ot(this, "initialized", !1),
            ot(this, "storagePrefix", sM),
            ot(this, "init", async () => {
              if (!this.initialized) {
            ...
            ot(this, "set", async (e, t, r) => {
              this.isInitialized();
              let i = iP(t),
                s = this.messages.get(e);
              if ((typeof s > "u" && (s = {}), "u" > typeof s[i])) return i;
              if (((s[i] = t), this.messages.set(e, s), r === sQ.inbound)) {
                ...
                this.messagesWithoutClientAck.set(
                  ...
                  n5(
                    ((e, t) => {
                      for (var r in t || (t = {}))
                        n9.call(t, r) && oe(e, r, t[r]);
                      if (n4)
                        for (var r of n4(t)) n7.call(t, r) && oe(e, r, t[r]);
                      return e;
                    })({}, r),
                    n6({ [i]: t })
                  )
            ...
            ot(
              this,
              "has",
              (e, t) => (this.isInitialized(), "u" > typeof this.get(e)[iP(t)])
            ),
            ot(this, "ack", async (e, t) => {
              this.isInitialized();
              let r = this.messagesWithoutClientAck.get(e);
            ...
            (this.logger = (0, sf.U5)(e, this.name)),
            (this.core = t);
        }
        get context() {
          return (0, sf.oI)(this.logger);
      ...
      var oi = Object.defineProperty,
        ...
        ol = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        oh = (e, t) => {
          for (var r in t || (t = {})) oa.call(t, r) && ol(e, r, t[r]);
          if (oo) for (var r of oo(t)) oc.call(t, r) && ol(e, r, t[r]);
          return e;
        },
        ou = (e, t) => os(e, on(t)),
        od = (e, t, r) => ol(e, "symbol" != typeof t ? t + "" : t, r);
      class op extends sI {
        constructor(e, t) {
          super(e, t),
            (this.relayer = e),
            (this.logger = t),
            od(this, "events", new i.EventEmitter()),
            od(this, "name", "publisher"),
            od(this, "queue", new Map()),
            od(this, "publishTimeout", (0, o.toMiliseconds)(o.ONE_MINUTE)),
            od(
              this,
              "initialPublishTimeout",
              (0, o.toMiliseconds)(15 * o.ONE_SECOND)
            ),
            od(this, "needsTransportRestart", !1),
            od(this, "publish", async (e, t, r) => {
              var i;
              ...
              let s = r?.ttl || sK,
                ...
                o = r?.prompt || !1,
                a = r?.tag || 0,
                c = r?.id || (0, sL.getBigIntRpcId)().toString(),
                l = {
                  topic: e,
                  message: t,
                  opts: {
              ...
              try {
                let i = new Promise(async (i) => {
                  let n = ({ id: e }) => {
                    l.opts.id === e &&
                      ...
                      this.relayer.events.removeListener(sJ.publish, n),
                      i(l));
                  };
                  this.relayer.events.on(sJ.publish, n);
                  let h = eC(
                    new Promise((i, n) => {
                      this.rpcPublish({
                        topic: e,
                  ...
                  try {
                    await h, this.events.removeListener(sJ.publish, n);
                  } catch (e) {
                    this.queue.set(c, ou(oh({}, l), { attempt: 1 })),
                ...
                this.logger.trace({
                  ...
                  await eC(i, this.publishTimeout, h);
              } catch (e) {
                if (
        ...
        async rpcPublish(e) {
          ...
          i6(null == (t = p.params) ? void 0 : t.prompt) &&
            (null == (r = p.params) || delete r.prompt),
            i6(null == (i = p.params) ? void 0 : i.tag) &&
          ...
          return (
            this.relayer.events.emit(sJ.publish, e),
        ...
        checkQueue() {
          this.queue.forEach(async (e, t) => {
            let r = e.attempt + 1;
            this.queue.set(t, ou(oh({}, e), { attempt: r }));
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(sd.li.pulse, () => {
            if (this.needsTransportRestart) {
              (this.needsTransportRestart = !1),
                this.relayer.events.emit(sJ.connection_stalled);
              return;
            }
            this.checkQueue();
          }),
            this.relayer.on(sJ.message_ack, (e) => {
      ...
      class oy {
        constructor() {
          og(this, "map", new Map()),
            ...
            og(this, "get", (e) => this.map.get(e) || []),
            og(this, "exists", (e, t) => this.get(e).includes(t)),
            og(this, "delete", (e, t) => {
      ...
      var om = Object.defineProperty,
        ...
        o_ = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        ox = (e, t) => {
          for (var r in t || (t = {})) oE.call(t, r) && o_(e, r, t[r]);
          if (ov) for (var r of ov(t)) oI.call(t, r) && o_(e, r, t[r]);
          return e;
        },
        oD = (e, t) => ob(e, ow(t)),
        oP = (e, t, r) => o_(e, "symbol" != typeof t ? t + "" : t, r);
      class oS extends sD {
        constructor(e, t) {
          super(e, t),
            (this.relayer = e),
            (this.logger = t),
            oP(this, "subscriptions", new Map()),
            oP(this, "topicMap", new oy()),
            oP(this, "events", new i.EventEmitter()),
            oP(this, "name", "subscription"),
            oP(this, "version", "0.3"),
            oP(this, "pending", new Map()),
            oP(this, "cached", []),
            oP(this, "initialized", !1),
            oP(this, "storagePrefix", sM),
            oP(this, "subscribeTimeout", (0, o.toMiliseconds)(o.ONE_MINUTE)),
            oP(
              this,
            ...
            oP(this, "clientId"),
            oP(this, "batchSubscribeTopicsLimit", 500),
            oP(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                this.registerEventListeners(),
            ...
            oP(this, "restart", async () => {
              await this.restore(), await this.onRestart();
            }),
            oP(this, "checkPending", async () => {
              if (
                0 === this.pending.size &&
            ...
            oP(this, "registerEventListeners", () => {
              this.relayer.core.heartbeat.on(sd.li.pulse, async () => {
                await this.checkPending();
              }),
                this.events.on(s0.created, async (e) => {
                  let t = s0.created;
                  this.logger.info(`Emitting ${t}`),
                    this.logger.debug({ type: "event", event: t, data: e }),
                    await this.persist();
                }),
                this.events.on(s0.deleted, async (e) => {
                  let t = s0.deleted;
                  this.logger.info(`Emitting ${t}`),
                    this.logger.debug({ type: "event", event: t, data: e }),
                    await this.persist();
        ...
        async unsubscribeById(e, t, r) {
          ...
          try {
            ...
            let s = i8("USER_DISCONNECTED", `${this.name}, ${e}`);
        ...
        async rpcSubscribe(e, t, r) {
          var i;
          (r && r?.transportType !== sZ.relay) ||
            (await this.restartToComplete({ topic: e, id: e, relay: t }));
          let s = { method: iL(t.protocol).subscribe, params: { topic: e } };
          this.logger.debug("Outgoing Relay Payload"),
            this.logger.trace({
              type: "payload",
              direction: "outgoing",
          ...
          try {
            ...
            if (r?.transportType === sZ.link_mode)
              return (
                setTimeout(() => {
            ...
            let i = new Promise(async (t) => {
                let r = (i) => {
                  i.topic === e &&
                    (this.events.removeListener(s0.created, r), t(i.id));
                };
                this.events.on(s0.created, r);
                try {
                  let i = await eC(
                    new Promise((e, t) => {
                      this.relayer
                  ...
                  this.events.removeListener(s0.created, r), t(i);
                } catch {}
              }),
              a = await eC(
                i,
        ...
        async rpcBatchSubscribe(e) {
          if (!e.length) return;
          let t = {
            method: iL(e[0].relay.protocol).batchSubscribe,
        ...
        async rpcBatchFetchMessages(e) {
          ...
          if (!e.length) return;
          let r = {
            method: iL(e[0].relay.protocol).batchFetchMessages,
            params: { topics: e.map((e) => e.topic) },
          };
          this.logger.debug("Outgoing Relay Payload"),
            this.logger.trace({
        ...
        rpcUnsubscribe(e, t, r) {
          let i = {
            method: iL(r.protocol).unsubscribe,
            params: { topic: e, id: t },
          };
          return (
            this.logger.debug("Outgoing Relay Payload"),
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, oD(ox({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, ox({}, e)),
        ...
        addSubscription(e, t) {
          this.subscriptions.set(e, ox({}, t)),
            this.topicMap.set(t.topic, e),
            this.events.emit(s0.created, t);
        }
        getSubscription(e) {
          ...
          if (!t) {
            let { message: t } = i2("NO_MATCHING_KEY", `${this.name}: ${e}`);
            throw Error(t);
          }
          return t;
        }
        deleteSubscription(e, t) {
          ...
          this.subscriptions.delete(e),
            ...
            this.events.emit(s0.deleted, oD(ox({}, r), { reason: t }));
        }
        async persist() {
          await this.setRelayerSubscriptions(this.values),
            this.events.emit(s0.sync);
        }
        async onRestart() {
          ...
          this.events.emit(s0.resubscribed);
        }
        async restore() {
          try {
            ...
            if (this.subscriptions.size) {
              let { message: e } = i2("RESTORE_WILL_OVERRIDE", this.name);
              throw (
                (this.logger.error(e),
                this.logger.error(
        ...
        async batchSubscribe(e) {
          e.length &&
            ...
            this.onBatchSubscribe(
              await Promise.all(
                e.map(async (e) =>
                  oD(ox({}, e), { id: await this.getSubscriptionId(e.topic) })
                )
              )
            ));
        }
        ...
        async getSubscriptionId(e) {
          return iP(e + (await this.getClientId()));
        }
      }
      var oO = Object.defineProperty,
        ...
        oT = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        oN = (e, t) => {
          for (var r in t || (t = {})) oC.call(t, r) && oT(e, r, t[r]);
          if (oA) for (var r of oA(t)) oR.call(t, r) && oT(e, r, t[r]);
          return e;
        },
        oj = (e, t, r) => oT(e, "symbol" != typeof t ? t + "" : t, r);
      class oU extends s_ {
        constructor(e) {
          super(e),
            oj(this, "protocol", "wc"),
            ...
            oj(this, "core"),
            oj(this, "logger"),
            oj(this, "events", new i.EventEmitter()),
            oj(this, "provider"),
            oj(this, "messages"),
            oj(this, "subscriber"),
            oj(this, "publisher"),
            oj(this, "name", "relayer"),
            oj(this, "transportExplicitlyClosed", !1),
            oj(this, "initialized", !1),
            oj(this, "connectionAttemptInProgress", !1),
            oj(this, "relayUrl"),
            oj(this, "projectId"),
            oj(this, "packageName"),
            oj(this, "bundleId"),
            oj(this, "hasExperiencedNetworkDisruption", !1),
            oj(this, "pingTimeout"),
            oj(
              this,
              "heartBeatTimeout",
            ...
            oj(this, "reconnectTimeout"),
            oj(this, "connectPromise"),
            oj(this, "reconnectInProgress", !1),
            oj(this, "requestsInFlight", []),
            oj(this, "connectTimeout", (0, o.toMiliseconds)(15 * o.ONE_SECOND)),
            oj(this, "request", async (e) => {
              var t, r;
              this.logger.debug("Publishing Request Payload");
              let i = e.id || (0, sL.getBigIntRpcId)().toString();
            ...
            oj(this, "onPayloadHandler", (e) => {
              this.onProviderPayload(e), this.resetPingTimeout();
            }),
            oj(this, "onConnectHandler", () => {
              this.logger.warn({}, "Relayer connected \uD83D\uDEDC"),
                this.startPingTimeout(),
                this.events.emit(sJ.connect);
            }),
            oj(this, "onDisconnectHandler", () => {
              this.logger.warn({}, "Relayer disconnected \uD83D\uDED1"),
                (this.requestsInFlight = []),
                this.onProviderDisconnect();
            }),
            oj(this, "onProviderErrorHandler", (e) => {
              this.logger.fatal(`Fatal socket error: ${e.message}`),
                this.events.emit(sJ.error, e),
                this.logger.fatal(
                  "Fatal socket error received, closing transport"
                ),
                this.transportClose();
            }),
            oj(this, "registerProviderListeners", () => {
              this.provider.on(sG.payload, this.onPayloadHandler),
                this.provider.on(sG.connect, this.onConnectHandler),
                this.provider.on(sG.disconnect, this.onDisconnectHandler),
                this.provider.on(sG.error, this.onProviderErrorHandler);
            }),
            (this.core = e.core),
            (this.logger =
              "u" > typeof e.logger && "string" != typeof e.logger
                ? (0, sf.U5)(e.logger, this.name)
                : (0, sf.h6)((0, sf.iP)({ level: e.logger || "error" }))),
            (this.messages = new or(this.logger, e.core)),
            (this.subscriber = new oS(this, this.logger)),
            (this.publisher = new op(this, this.logger)),
            (this.relayUrl = e?.relayUrl || sW),
        ...
        async subscribe(e, t) {
          ...
          let n =
            ...
            a,
            c = (t) => {
              t.topic === e && (this.subscriber.off(s0.created, c), a());
            };
          return (
            await Promise.all([
              new Promise((e) => {
                (a = e), this.subscriber.on(s0.created, c);
              }),
              new Promise(async (r, i) => {
                (o =
                  (await this.subscriber
                    .subscribe(
                      e,
                      oN({ internal: { throwOnFailedPublish: n } }, t)
                    )
                    .catch((e) => {
                      n && i(e);
                    })) || o),
        ...
        async onLinkMessageEvent(e, t) {
          ...
          this.events.emit(sJ.message, e),
            await this.recordMessageEvent(e, sQ.inbound);
        }
        async connect(e) {
          await this.confirmOnlineStateOrThrow(),
            e &&
            ...
            try {
              ...
              this.logger.debug(
                ...
                await new Promise(async (e, t) => {
                  ...
                  this.provider.once(sG.disconnect, r),
                    await eC(
                      new Promise((e, t) => {
                      ...
                      .finally(() => {
                        this.provider.off(sG.disconnect, r),
        ...
        async onProviderPayload(e) {
          if (
            ...
            this.logger.debug("Emitting Relayer Payload"),
              this.logger.trace(oN({ type: "event", event: t.id }, o)),
              this.events.emit(t.id, o),
              await this.acknowledgePayload(e),
              await this.onMessageEvent(o);
          } else
            (0, sL.isJsonRpcResponse)(e) && this.events.emit(sJ.message_ack, e);
        }
        ...
        async acknowledgePayload(e) {
          let t = (0, sL.formatJsonRpcResult)(e.id, !0);
          await this.provider.connection.send(t);
        }
        unregisterProviderListeners() {
          this.provider.off(sG.payload, this.onPayloadHandler),
            this.provider.off(sG.connect, this.onConnectHandler),
            this.provider.off(sG.disconnect, this.onDisconnectHandler),
            this.provider.off(sG.error, this.onProviderErrorHandler),
            clearTimeout(this.pingTimeout);
        }
        async registerEventListeners() {
          ...
          (function (e) {
            ...
            this.core.heartbeat.on(sd.li.pulse, async () => {
              var e;
              if (
        ...
        async onProviderDisconnect() {
          clearTimeout(this.pingTimeout),
            this.events.emit(sJ.disconnect),
            (this.connectionAttemptInProgress = !1),
      ...
      var oz = Object.defineProperty,
        ...
        oJ = (e, t, r) => oK(e, "symbol" != typeof t ? t + "" : t, r);
      class oG extends sx {
        constructor(e, t, r, i = sM, s) {
          super(e, t, r, i),
            (this.core = e),
            (this.logger = t),
            (this.name = r),
            ...
            oJ(this, "initialized", !1),
            oJ(this, "getKey"),
            oJ(this, "storagePrefix", sM),
            oJ(this, "recentlyDeleted", []),
            oJ(this, "recentlyDeletedLimit", 200),
            oJ(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
                this.cached.forEach((e) => {
                  this.getKey && null !== e && !i6(e)
                  ...
                  ? this.values.filter((t) =>
                      Object.keys(e).every((r) => {
                        ...
                        return (
                                ...
                                switch (o) {
                                  ...
                                  case oM: {
                                    if (
                                      ...
                                      return !1;
                                    let o = [...Object.keys(r), ...oq(r)],
                                      a = [...Object.keys(i), ...oq(i)];
                          ...
                          })(i, e[r], void 0, void 0, void 0, void 0, oL)
                        );
                      })
                    )
                  : this.values
            ...
            oJ(this, "update", async (e, t) => {
              ...
              let r = oW(oW({}, this.getData(e)), t);
              this.map.set(e, r), await this.persist();
            }),
            oJ(this, "delete", async (e, t) => {
              this.isInitialized(),
                this.map.has(e) &&
      ...
      class oQ {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            oZ(this, "name", "pairing"),
            oZ(this, "version", "0.3"),
            oZ(this, "events", new (s())()),
            oZ(this, "pairings"),
            oZ(this, "initialized", !1),
            oZ(this, "storagePrefix", sM),
            oZ(this, "ignoredPayloadTypes", [1]),
            oZ(this, "registeredMethods", []),
            oZ(this, "init", async () => {
              this.initialized ||
            ...
            oZ(this, "register", ({ methods: e }) => {
              this.isInitialized(),
                (this.registeredMethods = [
                  ...new Set([...this.registeredMethods, ...e]),
                ]);
            }),
            oZ(this, "create", async (e) => {
              this.isInitialized();
              let t = ix(),
            ...
            oZ(this, "pair", async (e) => {
              let t;
              this.isInitialized();
              let r = this.core.eventClient.createEvent({
                properties: { topic: e?.uri, trace: [s9.pairing_started] },
              });
              ...
              if (
                ...
                r.addTrace(s9.pairing_uri_validation_success),
                r.addTrace(s9.pairing_uri_not_expired),
                this.pairings.keys.includes(i))
              ) {
                if (
                  ((t = this.pairings.get(i)),
                  r.addTrace(s9.existing_pairing),
                  t.active)
                )
                  throw (
                    (r.setError(s7.active_pairing_already_exists),
                    Error(
                      `Pairing already exists: ${i}. Please try again with a new connection URI.`
                    ))
                  );
                r.addTrace(s9.pairing_not_expired);
              }
              let l = a || eN(o.FIVE_MINUTES),
                h = { topic: i, relay: n, expiry: l, active: !1, methods: c };
              this.core.expirer.set(i, l),
                await this.pairings.set(i, h),
                r.addTrace(s9.store_new_pairing),
                e.activatePairing && (await this.activate({ topic: i })),
                this.events.emit(s2.create, h),
                r.addTrace(s9.emit_inactive_pairing),
                this.core.crypto.keychain.has(i) ||
                  (await this.core.crypto.setSymKey(s, i)),
                r.addTrace(s9.subscribing_pairing_topic);
              try {
                await this.core.relayer.confirmOnlineStateOrThrow();
              } catch {
                r.setError(s7.no_internet_connection);
              }
              try {
                await this.core.relayer.subscribe(i, { relay: n });
              } catch (e) {
                throw (r.setError(s7.subscribe_pairing_topic_failure), e);
              }
              return r.addTrace(s9.subscribe_pairing_topic_success), h;
            }),
            oZ(this, "activate", async ({ topic: e }) => {
              this.isInitialized();
              let t = eN(o.FIVE_MINUTES);
              this.core.expirer.set(e, t),
                await this.pairings.update(e, { active: !0, expiry: t });
            }),
            oZ(this, "ping", async (e) => {
              this.isInitialized(),
              ...
              if (this.pairings.keys.includes(t)) {
                let e = await this.sendRequest(t, "wc_pairingPing", {}),
                  { done: r, resolve: i, reject: s } = eA();
                this.events.once(eU("pairing_ping", e), ({ error: e }) => {
                  e ? s(e) : i();
                }),
                  await r();
              }
            }),
            oZ(this, "updateExpiry", async ({ topic: e, expiry: t }) => {
              this.isInitialized(),
                await this.pairings.update(e, { expiry: t });
            }),
            oZ(this, "updateMetadata", async ({ topic: e, metadata: t }) => {
              this.isInitialized(),
            ...
            oZ(this, "disconnect", async (e) => {
              ...
              this.pairings.keys.includes(t) &&
                (await this.sendRequest(
                  t,
                  "wc_pairingDelete",
                  i8("USER_DISCONNECTED")
                ),
                await this.deletePairing(t));
            }),
            oZ(this, "formatUriFromPairing", (e) => {
              this.isInitialized();
            ...
            oZ(this, "sendRequest", async (e, t, r) => {
              let i = (0, sL.formatJsonRpcRequest)(t, r),
            ...
            oZ(this, "sendResult", async (e, t, r) => {
              let i = (0, sL.formatJsonRpcResult)(e, r),
                s = await this.core.crypto.encode(t, i),
                n = s1[(await this.core.history.get(t, e)).request.method].res;
              await this.core.relayer.publish(t, s, n),
                await this.core.history.resolve(i);
            }),
            oZ(this, "sendError", async (e, t, r) => {
              let i = (0, sL.formatJsonRpcError)(e, r),
                s = await this.core.crypto.encode(t, i),
                n = (await this.core.history.get(t, e)).request.method,
                o = s1[n] ? s1[n].res : s1.unregistered_method.res;
              await this.core.relayer.publish(t, s, o),
                await this.core.history.resolve(i);
            }),
            oZ(this, "deletePairing", async (e, t) => {
              await this.core.relayer.unsubscribe(e),
                await Promise.all([
                  this.pairings.delete(e, i8("USER_DISCONNECTED")),
                  this.core.crypto.deleteSymKey(e),
                  t ? Promise.resolve() : this.core.expirer.del(e),
                ]);
            }),
            oZ(this, "cleanup", async () => {
              let e = this.pairings.getAll().filter((e) => ej(e.expiry));
              await Promise.all(e.map((e) => this.deletePairing(e.topic)));
            }),
            oZ(this, "onRelayEventRequest", async (e) => {
            ...
            oZ(this, "onRelayEventResponse", async (e) => {
              let { topic: t, payload: r } = e,
            ...
            oZ(this, "onPairingPingRequest", async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidPing({ topic: e }),
                  await this.sendResult(r, e, !0),
                  this.events.emit(s2.ping, { id: r, topic: e });
              } catch (t) {
                await this.sendError(r, e, t), this.logger.error(t);
              }
            }),
            oZ(this, "onPairingPingResponse", (e, t) => {
              let { id: r } = t;
              setTimeout(() => {
                (0, sL.isJsonRpcResult)(t)
                  ? this.events.emit(eU("pairing_ping", r), {})
                  : (0, sL.isJsonRpcError)(t) &&
                    this.events.emit(eU("pairing_ping", r), { error: t.error });
              }, 500);
            }),
            oZ(this, "onPairingDeleteRequest", async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidDisconnect({ topic: e }),
                  await this.deletePairing(e),
                  this.events.emit(s2.delete, { id: r, topic: e });
              } catch (t) {
                await this.sendError(r, e, t), this.logger.error(t);
              }
            }),
            oZ(this, "onUnknownRpcMethodRequest", async (e, t) => {
              let { id: r, method: i } = t;
              try {
                if (this.registeredMethods.includes(i)) return;
                let t = i8("WC_METHOD_UNSUPPORTED", i);
                await this.sendError(r, e, t), this.logger.error(t);
              } catch (t) {
                await this.sendError(r, e, t), this.logger.error(t);
              }
            }),
            oZ(this, "onUnknownRpcMethodResponse", (e) => {
              this.registeredMethods.includes(e) ||
                this.logger.error(i8("WC_METHOD_UNSUPPORTED", e));
            }),
            oZ(this, "isValidPair", (e, t) => {
              var r;
              if (!ss(e)) {
                let { message: r } = i2(
                  "MISSING_OR_INVALID",
                ...
                throw (t.setError(s7.malformed_pairing_uri), Error(r));
              }
              if (
                !(function (e) {
                  function t(e) {
              ...
              if (!(null != (r = i?.relay) && r.protocol)) {
                ...
                throw (t.setError(s7.malformed_pairing_uri), Error(e));
              }
              if (!(null != i && i.symKey)) {
                let { message: e } = i2(
                  "MISSING_OR_INVALID",
            ...
            oZ(this, "isValidDisconnect", async (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
                  `disconnect() params: ${e}`
            ...
            oZ(this, "isValidPairingTopic", async (e) => {
              if (!i4(e, !1)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
              ...
              if (ej(this.pairings.get(e).expiry)) {
                await this.deletePairing(e);
                let { message: t } = i2("EXPIRED", `pairing topic: ${e}`);
                throw Error(t);
              }
            }),
            (this.core = e),
            (this.logger = (0, sf.U5)(t, this.name)),
            (this.pairings = new oG(
              this.core,
              this.logger,
              this.name,
              this.storagePrefix
        ...
        registerRelayerEvents() {
          this.core.relayer.on(sJ.message, async (e) => {
        ...
        registerExpirerEvents() {
          this.core.expirer.on(s3.expired, async (e) => {
            let { topic: t } = eT(e.target);
            t &&
              this.pairings.keys.includes(t) &&
              (await this.deletePairing(t, !0),
              this.events.emit(s2.expire, { topic: t }));
          });
        }
      }
      ...
      class o1 extends sv {
        constructor(e, t) {
          super(e, t),
            (this.core = e),
            (this.logger = t),
            o0(this, "records", new Map()),
            o0(this, "events", new i.EventEmitter()),
            o0(this, "name", "history"),
            o0(this, "version", "0.3"),
            o0(this, "cached", []),
            o0(this, "initialized", !1),
            o0(this, "storagePrefix", sM),
            o0(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
            ...
            o0(this, "set", (e, t, r) => {
              ...
              let i = {
                ...
                chainId: r,
                expiry: eN(o.THIRTY_DAYS),
              };
              this.records.set(i.id, i),
                this.persist(),
                this.events.emit(s8.created, i);
            }),
            o0(this, "resolve", async (e) => {
              if (
                (this.isInitialized(),
              ...
              typeof t.response > "u" &&
                ((t.response = (0, sL.isJsonRpcError)(e)
                  ? { error: e.error }
                  : { result: e.result }),
                this.records.set(t.id, t),
                this.persist(),
                this.events.emit(s8.updated, t));
            }),
            o0(
              this,
              "get",
        ...
        get pending() {
          ...
          return (
            this.values.forEach((t) => {
              ...
              let r = {
                topic: t.topic,
                request: (0, sL.formatJsonRpcRequest)(
                  t.request.method,
                  t.request.params,
                  t.id
                ),
        ...
        async persist() {
          await this.setJsonRpcRecords(this.values), this.events.emit(s8.sync);
        }
        async restore() {
          try {
        ...
        registerEventListeners() {
          this.events.on(s8.created, (e) => {
            let t = s8.created;
            this.logger.info(`Emitting ${t}`),
              this.logger.debug({ type: "event", event: t, record: e });
          }),
            this.events.on(s8.updated, (e) => {
              let t = s8.updated;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, record: e });
            }),
            this.events.on(s8.deleted, (e) => {
              let t = s8.deleted;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, record: e });
            }),
            this.core.heartbeat.on(sd.li.pulse, () => {
              this.cleanup();
            });
        }
        cleanup() {
          try {
            ...
            this.records.forEach((t) => {
              (0, o.toMiliseconds)(t.expiry || 0) - Date.now() <= 0 &&
                ...
                this.events.emit(s8.deleted, t, !1),
                (e = !0));
            }),
              e && this.persist();
          } catch (e) {
      ...
      class o3 extends sP {
        constructor(e, t) {
          super(e, t),
            (this.core = e),
            (this.logger = t),
            o8(this, "expirations", new Map()),
            o8(this, "events", new i.EventEmitter()),
            o8(this, "name", "expirer"),
            o8(this, "version", "0.3"),
            o8(this, "cached", []),
            o8(this, "initialized", !1),
            o8(this, "storagePrefix", sM),
            o8(this, "init", async () => {
              this.initialized ||
                (this.logger.trace("Initialized"),
                await this.restore(),
            ...
            o8(this, "set", (e, t) => {
              ...
              this.expirations.set(r, i),
                ...
                this.events.emit(s3.created, { target: r, expiration: i });
            }),
            o8(this, "get", (e) => {
              this.isInitialized();
              let t = this.formatTarget(e);
            ...
            o8(this, "del", (e) => {
              if ((this.isInitialized(), this.has(e))) {
                ...
                this.expirations.delete(t),
                  this.events.emit(s3.deleted, { target: t, expiration: r });
              }
            }),
            o8(this, "on", (e, t) => {
              this.events.on(e, t);
        ...
        formatTarget(e) {
          ...
          let { message: t } = i2("UNKNOWN_TYPE", `Target type: ${typeof e}`);
          throw Error(t);
        }
        ...
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(s3.expired, { target: e, expiration: t });
        }
        checkExpirations() {
        ...
        registerEventListeners() {
          this.core.heartbeat.on(sd.li.pulse, () => this.checkExpirations()),
      ...
      class o4 extends sS {
        constructor(e, t, r) {
          super(e, t, r),
            ...
            (this.logger = t),
            (this.store = r),
            o6(this, "name", "verify-api"),
            o6(this, "abortController"),
            o6(this, "isDevEnv"),
            o6(this, "verifyUrlV3", s6),
            o6(this, "storagePrefix", sM),
            o6(this, "version", 2),
            o6(this, "publicKey"),
            o6(this, "fetchPromise"),
            o6(this, "init", async () => {
              var e;
              this.isDevEnv ||
            ...
            o6(this, "register", async (e) => {
              if (!eE() || this.isDevEnv) return;
                      ...
                      if (s.data && "string" == typeof s.data)
                        try {
                          ...
                          if ("verify_attestation" === n.type) {
                            if ((0, er.Cq)(n.attestation).payload.id !== r)
                              return;
                            clearInterval(t),
                              e.body.removeChild(a),
            ...
            o6(this, "resolve", async (e) => {
              ...
              if (t) {
                if ((0, er.Cq)(t).payload.id !== i) return;
            ...
            o6(this, "fetchAttestation", async (e, t) => {
            ...
            o6(this, "getVerifyUrl", (e) => {
              let t = e || s5;
              return (
                s4.includes(t) ||
                  (this.logger.info(
                    `verify url: ${t}, not included in trusted list, assigning default: ${s5}`
                  ),
                  (t = s5)),
                t
              );
            }),
            o6(this, "fetchPublicKey", async () => {
              try {
                this.logger.debug(
            ...
            o6(this, "getPublicKey", async () =>
              this.publicKey
                ? this.publicKey
                : await this.fetchAndPersistPublicKey()
            ),
            o6(this, "fetchAndPersistPublicKey", async () => {
            ...
            o6(this, "validateAttestation", (e, t) => {
              let r = (function (e, t) {
                  let [r, i, s] = e.split("."),
                    n = eo.from(iC(s), "base64");
                  if (64 !== n.length) throw Error("Invalid signature length");
                  let o = n.slice(0, 32),
                    a = n.slice(32, 64),
                    c = ro(`${r}.${i}`),
                    l = (function (e) {
                      let t = eo.from(e.x, "base64"),
                        r = eo.from(e.y, "base64");
                      return (0, ei.xW)([new Uint8Array([4]), t, r]);
                    })(t);
                  if (!ib.verify((0, ei.xW)([o, a]), c, l))
      ...
      class ae extends sO {
        constructor(e, t) {
          super(e, t),
            (this.projectId = e),
            (this.logger = t),
            o7(this, "context", "echo"),
            o7(this, "registerDeviceToken", async (e) => {
              let {
                  clientId: t,
                  token: r,
                  notificationType: i,
            ...
            (this.logger = (0, sf.U5)(t, this.context));
        }
      }
      var at = Object.defineProperty,
        ...
        an = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        ao = (e, t) => {
          for (var r in t || (t = {})) ai.call(t, r) && an(e, r, t[r]);
          if (ar) for (var r of ar(t)) as.call(t, r) && an(e, r, t[r]);
          return e;
        },
        aa = (e, t, r) => an(e, "symbol" != typeof t ? t + "" : t, r);
      class ac extends sA {
        constructor(e, t, r = !0) {
          super(e, t, r),
            (this.core = e),
            (this.logger = t),
            aa(this, "context", "event-client"),
            aa(this, "storagePrefix", sM),
            aa(this, "storageVersion", 0.1),
            aa(this, "events", new Map()),
            aa(this, "shouldPersist", !1),
            aa(this, "init", async () => {
              if (!eM())
                try {
                  let e = {
            ...
            aa(this, "getEvent", (e) => {
              ...
              if (i) return ao(ao({}, i), this.setMethods(i.eventId));
            }),
            aa(this, "deleteEvent", (e) => {
              let { eventId: t } = e;
              this.events.delete(t), (this.shouldPersist = !0);
            }),
            aa(this, "setEventListeners", () => {
              this.core.heartbeat.on(sd.li.pulse, async () => {
            ...
            aa(this, "restore", async () => {
              try {
                ...
                e.forEach((e) => {
                  this.events.set(
                    e.eventId,
                    ao(ao({}, e), this.setMethods(e.eventId))
                  );
                });
              } catch (e) {
                this.logger.warn(e);
            ...
            aa(this, "sendEvent", async (e) => {
              let t = this.getAppDomain() ? "" : "&sp=desktop";
              return await fetch(
                `https://pulse.walletconnect.org/batch?projectId=${this.core.projectId}&st=events_sdk&sv=js-${sY}${t}`,
                { method: "POST", body: JSON.stringify(e) }
              );
            }),
            aa(this, "getAppDomain", () => ex().url),
            (this.logger = (0, sf.U5)(t, this.context)),
      ...
      var al = Object.defineProperty,
        ...
        ap = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        af = (e, t) => {
          for (var r in t || (t = {})) au.call(t, r) && ap(e, r, t[r]);
          if (ah) for (var r of ah(t)) ad.call(t, r) && ap(e, r, t[r]);
          return e;
        },
        ag = (e, t, r) => ap(e, "symbol" != typeof t ? t + "" : t, r);
      class ay extends sb {
        constructor(e) {
          var t;
          super(e),
            ...
            ag(this, "relayUrl"),
            ag(this, "projectId"),
            ag(this, "customStoragePrefix"),
            ag(this, "events", new i.EventEmitter()),
            ag(this, "logger"),
            ag(this, "heartbeat"),
            ag(this, "relayer"),
            ag(this, "crypto"),
            ...
            ag(this, "verify"),
            ag(this, "echoClient"),
            ag(this, "linkModeSupportedApps"),
            ag(this, "eventClient"),
            ag(this, "initialized", !1),
            ag(this, "logChunkController"),
            ag(this, "on", (e, t) => this.events.on(e, t)),
            ag(this, "once", (e, t) => this.events.once(e, t)),
            ag(this, "off", (e, t) => this.events.off(e, t)),
            ag(this, "removeListener", (e, t) =>
              this.events.removeListener(e, t)
            ),
            ag(
              this,
          ...
          let s = (0, sf.iP)({
            ...
            { logger: n, chunkLoggerController: o } = (0, sf.D5)({
              opts: s,
          ...
          (this.logChunkController = o),
            ...
            (this.logger = (0, sf.U5)(n, this.name)),
            (this.heartbeat = new sd.VH()),
            (this.crypto = new n8(this, this.logger, e?.keychain)),
            (this.history = new o1(this, this.logger)),
            (this.expirer = new o3(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new sp.A(af(af({}, sF), e?.storageOptions))),
            (this.relayer = new oU({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new oQ(this, this.logger)),
            (this.verify = new o4(this, this.logger, this.storage)),
            (this.echoClient = new ae(this.projectId || "", this.logger)),
            (this.linkModeSupportedApps = []),
            (this.eventClient = new ac(this, this.logger, e?.telemetryEnabled)),
        ...
        async addLinkModeSupportedApp(e) {
          this.linkModeSupportedApps.includes(e) ||
            ...
            await this.storage.setItem(sX, this.linkModeSupportedApps));
        }
        async initialize() {
          this.logger.trace("Initialized");
          try {
        ...
        isGlobalCoreDisabled() {
          try {
            return "u" > typeof sB && "true" === sB.env.DISABLE_GLOBAL_CORE;
          } catch {
            return !0;
          }
        }
      ...
      let am = "client",
        ...
        ax = { min: o.FIVE_MINUTES, max: o.SEVEN_DAYS },
        aD = { idle: "IDLE", active: "ACTIVE" },
        aP = {
      ...
      var aC = Object.defineProperty,
        ...
        aL = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        ak = (e, t) => {
          for (var r in t || (t = {})) aj.call(t, r) && aL(e, r, t[r]);
          if (aN) for (var r of aN(t)) aU.call(t, r) && aL(e, r, t[r]);
          return e;
        },
        aq = (e, t) => aR(e, aT(t)),
        aB = (e, t, r) => aL(e, "symbol" != typeof t ? t + "" : t, r);
      class a$ extends sN {
        constructor(e) {
          super(e),
            aB(this, "name", "engine"),
            ...
            aB(this, "requestQueue", { state: aD.idle, queue: [] }),
            aB(this, "sessionRequestQueue", { state: aD.idle, queue: [] }),
            aB(this, "requestQueueDelay", o.ONE_SECOND),
            aB(this, "expectedPairingMethodMap", new Map()),
            aB(this, "recentlyDeletedMap", new Map()),
            aB(this, "recentlyDeletedLimit", 200),
            aB(this, "relayMessageCache", []),
            aB(this, "pendingSessions", new Map()),
            aB(this, "init", async () => {
              this.initialized ||
                (await this.cleanup(),
                this.registerRelayerEvents(),
                ...
                this.client.core.pairing.register({ methods: Object.keys(a_) }),
                (this.initialized = !0),
                setTimeout(async () => {
            ...
            aB(this, "connect", async (e) => {
              ...
              let d = await this.client.core.crypto.generateKeyPair(),
                p = a_.wc_sessionPropose.req.ttl || o.FIVE_MINUTES,
                f = eN(p),
                g = aq(
                  ak(
                    ak(
                ...
                y = eU("session_connect", g.id),
                { reject: m, resolve: b, done: w } = eA(p, aE),
                v = ({ id: e }) => {
                  e === g.id &&
                    (this.client.events.off("proposal_expire", v),
                    this.pendingSessions.delete(g.id),
                    this.events.emit(y, { error: { message: aE, code: 0 } }));
                };
              return (
            ...
            aB(this, "approve", async (e) => {
              var t, r, i;
              let s = this.client.core.eventClient.createEvent({
                properties: {
                  topic: null == (t = e?.id) ? void 0 : t.toString(),
                  trace: [ne.session_approve_started],
                },
              });
              try {
                this.isInitialized(), await this.confirmOnlineStateOrThrow();
              } catch (e) {
                throw (s.setError(nt.no_internet_connection), e);
              }
              try {
                ...
                throw (
                  ...
                  s.setError(nt.proposal_not_found),
                  t)
                );
              }
              try {
                ...
                throw (
                  ...
                  s.setError(nt.session_approve_namespace_validation_failure),
                  e)
                );
              }
              let {
              ...
              y ||
                (y =
                  null == (i = this.client.core.eventClient)
                    ? void 0
                    : i.createEvent({
                        type: ne.session_approve_started,
                        properties: {
                          topic: d,
                          trace: [
                            ne.session_approve_started,
                            ne.session_namespaces_validation_success,
                          ],
                        },
                      }));
              let m = await this.client.core.crypto.generateKeyPair(),
                ...
                E = sZ.relay;
              y.addTrace(ne.subscribing_session_topic);
              try {
                await this.client.core.relayer.subscribe(w, {
                  transportType: E,
                });
              } catch (e) {
                throw (y.setError(nt.subscribe_session_topic_failure), e);
              }
              y.addTrace(ne.subscribe_session_topic_success);
              let I = aq(ak({}, v), {
                topic: w,
                requiredNamespaces: f,
                optionalNamespaces: g,
              ...
              await this.client.session.set(w, I), y.addTrace(ne.store_session);
              try {
                y.addTrace(ne.publishing_session_settle),
                  await this.sendRequest({
                    topic: w,
                    ...
                    throw (y?.setError(nt.session_settle_publish_failure), e);
                  }),
                  y.addTrace(ne.session_settle_publish_success),
                  y.addTrace(ne.publishing_session_approve),
                  await this.sendResult({
                    ...
                    throw (y?.setError(nt.session_approve_publish_failure), e);
                  }),
                  y.addTrace(ne.session_approve_publish_success);
              } catch (e) {
                throw (
                  (this.client.logger.error(e),
                  this.client.session.delete(w, i8("USER_DISCONNECTED")),
              ...
              return (
                ...
                await this.client.proposal.delete(n, i8("USER_DISCONNECTED")),
                await this.client.core.pairing.activate({ topic: d }),
                await this.setExpiry(w, eN(aI)),
                {
                  topic: w,
                  acknowledged: () =>
            ...
            aB(this, "reject", async (e) => {
              ...
              t &&
                (await this.sendError({
                  ...
                  topic: t,
                  error: i,
                  rpcOpts: a_.wc_sessionPropose.reject,
                }),
                await this.client.proposal.delete(r, i8("USER_DISCONNECTED")));
            }),
            aB(this, "update", async (e) => {
              this.isInitialized(), await this.confirmOnlineStateOrThrow();
              try {
              ...
              let { topic: t, namespaces: r } = e,
                { done: i, resolve: s, reject: n } = eA(),
                o = (0, sL.payloadId)(),
                a = (0, sL.getBigIntRpcId)().toString(),
                c = this.client.session.get(t).namespaces;
              return (
                this.events.once(eU("session_update", o), ({ error: e }) => {
                  e ? n(e) : s();
                }),
            ...
            aB(this, "extend", async (e) => {
              ...
              let { topic: t } = e,
                ...
                { done: i, resolve: s, reject: n } = eA();
              return (
                this.events.once(eU("session_extend", r), ({ error: e }) => {
                  e ? n(e) : s();
                }),
                await this.setExpiry(t, eN(aI)),
                this.sendRequest({
                  topic: t,
            ...
            aB(this, "request", async (e) => {
              ...
              let {
                  ...
                  request: r,
                  topic: i,
                  expiry: s = a_.wc_sessionRequest.req.ttl,
                } = e,
                n = this.client.session.get(i);
              n?.transportType === sZ.relay &&
                (await this.confirmOnlineStateOrThrow());
              let o = (0, sL.payloadId)(),
                a = (0, sL.getBigIntRpcId)().toString(),
                {
                  done: c,
                  resolve: l,
                  reject: h,
                } = eA(s, "Request expired. Please try again.");
              this.events.once(
                eU("session_request", o),
                ({ error: e, result: t }) => {
                  e ? h(e) : l(t);
                }
              );
              ...
              if (d)
                return (
                  await this.sendRequest({
                    ...
                    method: u,
                    params: {
                      request: aq(ak({}, r), { expiryTimestamp: eN(s) }),
                      chainId: t,
                    },
                    expiry: s,
                    throwOnFailedPublish: !0,
              ...
              return await Promise.all([
                ...
                new Promise(async (e) => {
                  ...
                  if (!(null != (t = n.sessionConfig) && t.disableDeepLink)) {
                    let e = await eq(this.client.core.storage, av);
                    await ek({ id: o, topic: i, wcDeepLink: e });
                  }
                  e();
                }),
                c(),
            ...
            aB(this, "ping", async (e) => {
              ...
              if (this.client.session.keys.includes(t)) {
                let e = (0, sL.payloadId)(),
                  r = (0, sL.getBigIntRpcId)().toString(),
                  { done: i, resolve: s, reject: n } = eA();
                this.events.once(eU("session_ping", e), ({ error: e }) => {
                  e ? n(e) : s();
                }),
                  await Promise.all([
                    this.sendRequest({
            ...
            aB(this, "getPendingSessionRequests", () =>
              this.client.pendingRequest.getAll()
            ),
            aB(this, "authenticate", async (e, t) => {
              var r, i, s;
              let n;
              ...
              let o =
                  ...
                  (null == (r = this.client.metadata.redirect)
                    ? void 0
                    : r.linkMode),
                a = o ? sZ.link_mode : sZ.relay;
              a === sZ.relay && (await this.confirmOnlineStateOrThrow());
              let {
                  chains: c,
                  statement: l = "",
                  uri: h,
              ...
              if (
                (await Promise.all([
                  this.client.auth.authKeys.set(aA, {
                    responseTopic: I,
                    publicKey: E,
                  }),
                          ...
                          Object.keys(
                            ...
                            .forEach((s) => {
                              ...
                              i.att[r] = tg(
                                ((e, t) => {
                                  for (var r in t || (t = {}))
                                    tb.call(t, r) && tv(e, r, t[r]);
                                  if (tm)
                                    for (var r of tm(t))
                                      tw.call(t, r) && tv(e, r, t[r]);
                                  return e;
                                })({}, i.att[r]),
                                ty({
                                  [s]:
              ...
              let _ =
                  m && m > a_.wc_sessionAuthenticate.req.ttl
                    ? m
                    : a_.wc_sessionAuthenticate.req.ttl,
                x = {
                  authPayload: {
                    type: p ?? "caip122",
                    chains: c,
                ...
                D = {
                  ...
                  expiryTimestamp: eN(a_.wc_sessionPropose.req.ttl),
                  id: (0, sL.payloadId)(),
                },
                { done: P, resolve: S, reject: O } = eA(_, "Request expired"),
                A = (0, sL.payloadId)(),
                C = eU("session_connect", D.id),
                R = eU("session_request", A),
                ...
                N = async (e) => {
                  ...
                  l.length > 0 &&
                    ((n = {
                      ...
                      relay: { protocol: "irn" },
                      pairingTopic: w,
                      namespaces: iX([...new Set(l)], [...new Set(h)]),
                      transportType: a,
                    }),
              ...
              try {
                if (o) {
                  let e = (0, sL.formatJsonRpcRequest)(
                    "wc_sessionAuthenticate",
                    x,
                    A
                  );
                  ...
                  await Promise.all([
                    ...
                    this.sendRequest({
                      ...
                      method: "wc_sessionPropose",
                      params: D,
                      expiry: a_.wc_sessionPropose.req.ttl,
                      throwOnFailedPublish: !0,
                      clientRpcId: D.id,
                    }),
                  ]);
            ...
            aB(this, "approveSessionAuthenticate", async (e) => {
              let t,
                { id: r, auths: i } = e,
                s = this.client.core.eventClient.createEvent({
                  properties: {
                    topic: r.toString(),
                    trace: [nr.authenticated_session_approve_started],
                  },
                });
              try {
                this.isInitialized();
              } catch (e) {
                throw (s.setError(ni.no_internet_connection), e);
              }
              let n = this.getPendingAuthRequest(r);
              if (!n)
                throw (
                  (s.setError(
                    ni.authenticated_session_pending_request_not_found
                  ),
                  Error(`Could not find pending auth request with id ${r}`))
                );
              let o = n.transportType || sZ.relay;
              o === sZ.relay && (await this.confirmOnlineStateOrThrow());
              ...
              if (
                (s.addTrace(nr.create_authenticated_session_topic),
                u?.length > 0)
              ) {
                (t = {
                  topic: p,
                  ...
                  namespaces: iX([...new Set(u)], [...new Set(d)]),
                  transportType: o,
                }),
                  s.addTrace(nr.subscribing_authenticated_session_topic);
                try {
                  ...
                  throw (
                    (s.setError(
                      ni.subscribe_authenticated_session_topic_failure
                    ),
                    e)
                  );
                }
                s.addTrace(nr.subscribe_authenticated_session_topic_success),
                  await this.client.session.set(p, t),
                  s.addTrace(nr.store_authenticated_session),
                  await this.client.core.pairing.updateMetadata({
                    topic: n.pairingTopic,
                    metadata: n.requester.metadata,
                  });
              }
              s.addTrace(nr.publishing_authenticated_session_approve);
              try {
                await this.sendResult({
                  topic: l,
                  id: r,
                ...
                throw (
                  (s.setError(ni.authenticated_session_approve_publish_failure),
                  e)
                );
              }
              return (
            ...
            aB(this, "rejectSessionAuthenticate", async (e) => {
              ...
              await this.sendError({
                ...
                rpcOpts: a_.wc_sessionAuthenticate.reject,
                ...
                await this.client.proposal.delete(t, i8("USER_DISCONNECTED"));
            }),
            aB(this, "formatAuthMessage", (e) => {
              this.isInitialized();
              let { request: t, iss: r } = e;
              return tD(t, r);
            }),
            aB(this, "processRelayMessageCache", () => {
              setTimeout(async () => {
            ...
            aB(this, "cleanupDuplicatePairings", async (e) => {
              if (e.pairingTopic)
                try {
            ...
            aB(this, "deleteSession", async (e) => {
              ...
              await this.client.core.relayer.unsubscribe(r),
                await this.client.session.delete(r, i8("USER_DISCONNECTED")),
                ...
                r ===
                  (null == (t = this.sessionRequestQueue.queue[0])
                    ? void 0
                    : t.topic) && (this.sessionRequestQueue.state = aD.idle),
                s &&
            ...
            aB(this, "deleteProposal", async (e, t) => {
              if (t)
                try {
                  ...
                  r?.setError(nt.proposal_expired);
                } catch {}
              await Promise.all([
                this.client.proposal.delete(e, i8("USER_DISCONNECTED")),
                t ? Promise.resolve() : this.client.core.expirer.del(e),
              ]),
                this.addToRecentlyDeleted(e, "proposal");
            }),
            aB(this, "deletePendingSessionRequest", async (e, t, r = !1) => {
              await Promise.all([
                ...
                r &&
                  ((this.sessionRequestQueue.state = aD.idle),
                  this.client.events.emit("session_request_expire", { id: e }));
            }),
            aB(this, "deletePendingAuthRequest", async (e, t, r = !1) => {
              await Promise.all([
                this.client.auth.requests.delete(e, t),
                r ? Promise.resolve() : this.client.core.expirer.del(e),
              ]);
            }),
            aB(this, "setExpiry", async (e, t) => {
              this.client.session.keys.includes(e) &&
                (this.client.core.expirer.set(e, t),
                await this.client.session.update(e, { expiry: t }));
            }),
            aB(this, "setProposal", async (e, t) => {
              this.client.core.expirer.set(e, eN(a_.wc_sessionPropose.req.ttl)),
                await this.client.proposal.set(e, t);
            }),
            aB(this, "setAuthRequest", async (e, t) => {
              let {
                request: r,
                pairingTopic: i,
                transportType: s = sZ.relay,
              } = t;
            ...
            aB(this, "setPendingSessionRequest", async (e) => {
              let { id: t, topic: r, params: i, verifyContext: s } = e,
                n =
                  i.request.expiryTimestamp || eN(a_.wc_sessionRequest.req.ttl);
            ...
            aB(this, "sendRequest", async (e) => {
              let t,
                ...
                p = (0, sL.formatJsonRpcRequest)(n, o, l),
                f = !!u;
              try {
                let e = f ? iI : iE;
              ...
              if (
                ...
                a && (e.ttl = a),
                  c && (e.id = c),
                  (e.tvf = aq(ak({}, d), { correlationId: p.id })),
                  h
                    ? ((e.internal = aq(ak({}, e.internal), {
                        throwOnFailedPublish: !0,
                      })),
            ...
            aB(this, "sendResult", async (e) => {
              let t,
                ...
                u = (0, sL.formatJsonRpcResult)(n, a),
              ...
              if (d) {
                ...
                let e = a_[i.request.method].res;
                (e.tvf = aq(ak({}, s), { correlationId: n })),
                  c
                    ? ((e.internal = aq(ak({}, e.internal), {
                        throwOnFailedPublish: !0,
                      })),
            ...
            aB(this, "cleanup", async () => {
              ...
              this.client.session.getAll().forEach((t) => {
                ...
                this.client.proposal.getAll().forEach((e) => {
                  ej(e.expiryTimestamp) && t.push(e.id);
                }),
                await Promise.all([
            ...
            aB(this, "onProviderMessageEvent", async (e) => {
            ...
            aB(this, "processRequestsQueue", async () => {
              if (this.requestQueue.state === aD.active)
              ...
              for (
                ...
                this.requestQueue.state = aD.active;
              ...
              this.requestQueue.state = aD.idle;
            }),
            aB(this, "processRequest", async (e) => {
              let {
                  topic: t,
                  payload: r,
                  attestation: i,
            ...
            aB(this, "onRelayEventUnknownPayload", (e) => {
              let { topic: t } = e,
                { message: r } = i2(
                  "MISSING_OR_INVALID",
            ...
            aB(this, "shouldIgnorePairingRequest", (e) => {
            ...
            aB(this, "onSessionProposeRequest", async (e) => {
              ...
              try {
                ...
                0 === this.client.events.listenerCount("session_proposal") &&
                  ...
                  e?.setError(s7.proposal_listener_not_found)),
                  this.isValidConnect(ak({}, r.params));
                let a = n.expiryTimestamp || eN(a_.wc_sessionPropose.req.ttl),
                  c = ak({ id: o, pairingTopic: t, expiryTimestamp: a }, n);
                await this.setProposal(o, c);
                let l = await this.getVerifyContext({
                  attestationId: i,
                  hash: iP(JSON.stringify(r)),
                  encryptedId: s,
                  metadata: c.proposer.metadata,
                });
                e?.addTrace(s9.emit_session_proposal),
                ...
                await this.sendError({
                  ...
                  topic: t,
                  error: e,
                  rpcOpts: a_.wc_sessionPropose.autoReject,
                }),
                  this.client.logger.error(e);
              }
            }),
            aB(this, "onSessionProposeResponse", async (e, t, r) => {
              let { id: i } = t;
              if ((0, sL.isJsonRpcResult)(t)) {
                let { result: s } = t;
              ...
              } else if ((0, sL.isJsonRpcError)(t)) {
                await this.client.proposal.delete(i, i8("USER_DISCONNECTED"));
                let e = eU("session_connect", i);
                if (0 === this.events.listenerCount(e))
                  throw Error(`emitting ${e} without any listeners, 954`);
                this.events.emit(e, { error: t.error });
              }
            }),
            aB(this, "onSessionSettleRequest", async (e, t) => {
              let { id: r, params: i } = t;
              try {
                ...
                await this.client.session.set(d.topic, d),
                  ...
                  this.events.emit(eU("session_connect", h.proposalId), {
                    session: d,
                  }),
            ...
            aB(this, "onSessionSettleResponse", async (e, t) => {
              let { id: r } = t;
              (0, sL.isJsonRpcResult)(t)
                ? (await this.client.session.update(e, { acknowledged: !0 }),
                  this.events.emit(eU("session_approve", r), {}))
                : (0, sL.isJsonRpcError)(t) &&
                  (await this.client.session.delete(e, i8("USER_DISCONNECTED")),
                  this.events.emit(eU("session_approve", r), {
                    error: t.error,
                  }));
            }),
            aB(this, "onSessionUpdateRequest", async (e, t) => {
              let { params: r, id: i } = t;
              try {
                ...
                if (s && this.isRequestOutOfSync(s, i)) {
                  this.client.logger.warn(
                    ...
                    this.sendError({
                      id: i,
                      topic: e,
                      error: i8("INVALID_UPDATE_REQUEST"),
                    });
                  return;
                }
                this.isValidUpdate(ak({ topic: e }, r));
                try {
                  su.set(t, i),
            ...
            aB(this, "onSessionUpdateResponse", (e, t) => {
              let { id: r } = t,
                i = eU("session_update", r);
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              (0, sL.isJsonRpcResult)(t)
                ? this.events.emit(eU("session_update", r), {})
                : (0, sL.isJsonRpcError)(t) &&
                  this.events.emit(eU("session_update", r), { error: t.error });
            }),
            aB(this, "onSessionExtendRequest", async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidExtend({ topic: e }),
                  await this.setExpiry(e, eN(aI)),
                  await this.sendResult({
                    id: r,
                    topic: e,
                    result: !0,
            ...
            aB(this, "onSessionExtendResponse", (e, t) => {
              let { id: r } = t,
                i = eU("session_extend", r);
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              (0, sL.isJsonRpcResult)(t)
                ? this.events.emit(eU("session_extend", r), {})
                : (0, sL.isJsonRpcError)(t) &&
                  this.events.emit(eU("session_extend", r), { error: t.error });
            }),
            aB(this, "onSessionPingRequest", async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidPing({ topic: e }),
                  await this.sendResult({
            ...
            aB(this, "onSessionPingResponse", (e, t) => {
              let { id: r } = t,
                i = eU("session_ping", r);
              setTimeout(() => {
                if (0 === this.events.listenerCount(i))
                ...
                (0, sL.isJsonRpcResult)(t)
                  ? this.events.emit(eU("session_ping", r), {})
                  : (0, sL.isJsonRpcError)(t) &&
                    this.events.emit(eU("session_ping", r), { error: t.error });
              }, 500);
            }),
            aB(this, "onSessionDeleteRequest", async (e, t) => {
              let { id: r } = t;
              try {
                this.isValidDisconnect({ topic: e, reason: t.params }),
                  Promise.all([
                    new Promise((t) => {
                      this.client.core.relayer.once(sJ.publish, async () => {
            ...
            aB(this, "onSessionRequest", async (e) => {
              var t, r, i;
              let {
                  topic: s,
                  payload: n,
                ...
                { id: l, params: h } = n;
              try {
                await this.isValidRequest(ak({ topic: s }, h));
                let e = this.client.session.get(s),
                  n = await this.getVerifyContext({
                    attestationId: o,
                    hash: iP(
                      JSON.stringify(
                        (0, sL.formatJsonRpcRequest)("wc_sessionRequest", h, l)
                      )
                    ),
                    encryptedId: a,
            ...
            aB(this, "onSessionRequestResponse", (e, t) => {
              let { id: r } = t,
                i = eU("session_request", r);
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              (0, sL.isJsonRpcResult)(t)
                ? this.events.emit(eU("session_request", r), {
                    result: t.result,
                  })
                : (0, sL.isJsonRpcError)(t) &&
                  this.events.emit(eU("session_request", r), {
            ...
            aB(this, "onSessionEventRequest", async (e, t) => {
              let { id: r, params: i } = t;
              try {
            ...
            aB(this, "onSessionAuthenticateResponse", (e, t) => {
              let { id: r } = t;
              this.client.logger.trace({
                type: "method",
            ...
            aB(this, "onSessionAuthenticateRequest", async (e) => {
              var t;
              let {
                topic: r,
                payload: i,
              ...
              try {
                ...
                await this.sendError({
                  ...
                  rpcOpts: a_.wc_sessionAuthenticate.autoReject,
                  appLink: s,
                });
              }
            }),
            aB(this, "addSessionRequestToSessionRequestQueue", (e) => {
              this.sessionRequestQueue.queue.push(e);
            }),
            aB(this, "cleanupAfterResponse", (e) => {
              ...
              ({ topic: e, error: t }) => {
                ...
                r.length > 0 &&
                  r
                    ...
                    .forEach((e) => {
                      let r = eU("session_request", e.request.id);
                      if (0 === this.events.listenerCount(r))
                        throw Error(`emitting ${r} without any listeners`);
                      this.events.emit(eU("session_request", e.request.id), {
                        error: t,
                      });
                    });
              }
            ),
            aB(this, "processSessionRequestQueue", () => {
              if (this.sessionRequestQueue.state === aD.active)
                return void this.client.logger.info(
              ...
              try {
                (this.sessionRequestQueue.state = aD.active),
                  this.emitSessionRequest(e);
              } catch (e) {
                this.client.logger.error(e);
              }
            }),
            aB(this, "emitSessionRequest", (e) => {
              this.client.events.emit("session_request", e);
            }),
            aB(this, "onPairingCreated", (e) => {
              if (
                (e.methods &&
              ...
              t &&
                this.onSessionProposeRequest({
                  topic: e.topic,
                  payload: (0, sL.formatJsonRpcRequest)(
                    "wc_sessionPropose",
                    aq(ak({}, t), {
            ...
            aB(this, "isValidConnect", async (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
              ...
              if (
                (i6(t) || (await this.isValidPairingTopic(t)),
                !(function (e, t) {
                  let r = !1;
                  return (
                    t && !e
              ...
              if (
                ...
                i6(s) || this.validateSessionProps(s, "sessionProperties"),
                !i6(n))
              ) {
            ...
            aB(this, "validateNamespaces", (e, t) => {
            ...
            aB(this, "isValidApprove", async (e) => {
              if (!ss(e))
                throw Error(
                  i2("MISSING_OR_INVALID", `approve() params: ${e}`).message
                );
              let {
                id: t,
                namespaces: r,
              ...
              let c = so(o.requiredNamespaces, r, "approve()");
            ...
            aB(this, "isValidSessionSettleRequest", (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
              ...
              let o = sr(i, "onSessionSettleRequest()");
              if (o) throw Error(o.message);
              if (ej(s)) {
                let { message: e } = i2("EXPIRED", "onSessionSettleRequest()");
                throw Error(e);
              }
            }),
            aB(this, "isValidUpdate", async (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
                  `update() params: ${e}`
              ...
              let n = so(i.requiredNamespaces, r, "update()");
              if (n) throw Error(n.message);
            }),
            aB(this, "isValidExtend", async (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
                  `extend() params: ${e}`
            ...
            aB(this, "isValidRequest", async (e) => {
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
                  `request() params: ${e}`
                ...
                !(function (e, t, r) {
                  return (
                    ...
                    (function (e, t) {
                      ...
                      return (
                        Object.values(e).forEach((e) => {
                          iG(e.accounts).includes(t) && r.push(...e.methods);
                        }),
                        r
                      );
                    })(e, t).includes(r)
              ...
              if (
                s &&
                !(function (e, t) {
                  return i9(e, !1) && e <= t.max && e >= t.min;
                })(s, ax)
              ) {
                let { message: e } = i2(
                  "MISSING_OR_INVALID",
                  `request() expiry: ${s}. Expiry must be a number (in seconds) between ${ax.min} and ${ax.max}`
                );
                throw Error(e);
              }
            }),
            aB(this, "isValidRespond", async (e) => {
              var t;
              if (!ss(e)) {
                let { message: t } = i2(
                  "MISSING_OR_INVALID",
                ...
                !(function (e, t, r) {
                  return (
                    ...
                    (function (e, t) {
                      ...
                      return (
                        Object.values(e).forEach((e) => {
                          iG(e.accounts).includes(t) && r.push(...e.events);
                        }),
                        r
                      );
                    })(e, t).includes(r)
            ...
            aB(this, "isValidAuthenticate", (e) => {
              ...
              if (!i4(s, !1)) throw Error("nonce is required parameter");
              if ([...new Set(t.map((e) => ea(e).namespace))].length > 1)
                throw Error(
                  "Multi-namespace requests are not supported. Please request single namespace only."
                );
              let { namespace: n } = ea(t[0]);
              if ("eip155" !== n)
                throw Error(
                  "Only eip155 namespace is supported for authenticated sessions. Please use .connect() for non-eip155 chains."
                );
            }),
            aB(this, "getVerifyContext", async (e) => {
              let {
                  attestationId: t,
                  hash: r,
                  encryptedId: i,
            ...
            aB(this, "validateSessionProps", (e, t) => {
            ...
            aB(this, "checkRecentlyDeleted", (e) => {
            ...
            aB(this, "getAppLinkIfEnabled", (e, t) => {
              var r;
            ...
            aB(this, "handleLinkModeMessage", ({ url: e }) => {
              if (!e || !e.includes("wc_ev") || !e.includes("topic")) return;
              let t = eB(e, "topic") || "",
                r = decodeURIComponent(eB(e, "wc_ev") || ""),
                i = this.client.session.keys.includes(t);
              i &&
                this.client.session.update(t, { transportType: sZ.link_mode }),
            ...
            aB(this, "registerLinkModeListeners", async () => {
              var e;
              if (
                eM() ||
                (ev() &&
            ...
            aB(this, "shouldSetTVF", (e, t) => {
              if (!t || "wc_sessionRequest" !== e) return !1;
              let { request: r } = t;
              return Object.keys(aP).includes(r.method);
            }),
            aB(this, "getTVFParams", (e, t, r) => {
              var i, s;
              try {
            ...
            aB(this, "extractTxHashesFromResult", (e, t) => {
              try {
                let r = aP[e];
                  ...
                  return "solana_signAllTransactions" === e
                    ? i.map((e) =>
                        (function (e) {
                          ...
                          let s = eo.from(e, "base64").slice(1, 65);
                          return et.A.encode(s);
                        })(e)
                      )
                    : i;
        ...
        registerRelayerEvents() {
          this.client.core.relayer.on(sJ.message, (e) => {
            this.onProviderMessageEvent(e);
          });
        }
        async onRelayMessage(e) {
          let { topic: t, message: r, attestation: i, transportType: s } = e,
            { publicKey: n } = this.client.auth.authKeys.keys.includes(aA)
              ? this.client.auth.authKeys.get(aA)
              : { responseTopic: void 0, publicKey: void 0 };
          try {
            let e = await this.client.core.crypto.decode(t, r, {
              receiverPublicKey: n,
              encoding: s === sZ.link_mode ? iI : iE,
            });
            (0, sL.isJsonRpcRequest)(e)
        ...
        registerExpirerEvents() {
          this.client.core.expirer.on(s3.expired, async (e) => {
            let { topic: t, id: r } = eT(e.target);
            return r && this.client.pendingRequest.keys.includes(r)
              ? await this.deletePendingSessionRequest(r, i2("EXPIRED"), !0)
              : r && this.client.auth.requests.keys.includes(r)
              ? await this.deletePendingAuthRequest(r, i2("EXPIRED"), !0)
              : void (t
        ...
        registerPairingEvents() {
          this.client.core.pairing.events.on(s2.create, (e) =>
            this.onPairingCreated(e)
          ),
            this.client.core.pairing.events.on(s2.delete, (e) => {
        ...
        isValidPairingTopic(e) {
          ...
          if (ej(this.client.core.pairing.pairings.get(e).expiry)) {
            let { message: t } = i2("EXPIRED", `pairing topic: ${e}`);
            throw Error(t);
          }
        }
        async isValidSessionTopic(e) {
          ...
          if (ej(this.client.session.get(e).expiry)) {
            await this.deleteSession({ topic: e });
            let { message: t } = i2("EXPIRED", `session topic: ${e}`);
            throw Error(t);
          }
        ...
        async isValidProposalId(e) {
          ...
          if (ej(this.client.proposal.get(e).expiryTimestamp)) {
            await this.deleteProposal(e);
            let { message: t } = i2("EXPIRED", `proposal id: ${e}`);
            throw Error(t);
          }
        }
      }
      class aM extends oG {
        constructor(e, t) {
          super(e, t, "proposal", ab), (this.core = e), (this.logger = t);
        }
      }
      class az extends oG {
        constructor(e, t) {
          super(e, t, "session", ab), (this.core = e), (this.logger = t);
        }
      }
      class aF extends oG {
        constructor(e, t) {
          super(e, t, "request", ab, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      ...
      class aV extends oG {
        constructor(e, t) {
          super(e, t, "pairingTopics", aO), (this.core = e), (this.logger = t);
        }
      }
      class aK extends oG {
        constructor(e, t) {
          super(e, t, "requests", aO, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      ...
      class aG {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            aJ(this, "authKeys"),
            aJ(this, "pairingTopics"),
            aJ(this, "requests"),
            (this.authKeys = new aH(this.core, this.logger)),
            (this.pairingTopics = new aV(this.core, this.logger)),
            (this.requests = new aK(this.core, this.logger));
        }
        async init() {
      ...
      class aQ extends sT {
        constructor(e) {
          super(e),
            aZ(this, "protocol", "wc"),
            aZ(this, "version", 2),
            aZ(this, "name", aw.name),
            aZ(this, "metadata"),
            aZ(this, "core"),
            aZ(this, "logger"),
            aZ(this, "events", new i.EventEmitter()),
            aZ(this, "engine"),
            aZ(this, "session"),
            aZ(this, "proposal"),
            aZ(this, "pendingRequest"),
            aZ(this, "auth"),
            aZ(this, "signConfig"),
            ...
            aZ(this, "removeAllListeners", (e) =>
              this.events.removeAllListeners(e)
            ),
            aZ(this, "connect", async (e) => {
              try {
            ...
            aZ(this, "getPendingSessionRequests", () => {
              try {
            ...
            aZ(this, "authenticate", async (e, t) => {
              try {
            ...
            aZ(this, "approveSessionAuthenticate", async (e) => {
              try {
            ...
            aZ(this, "rejectSessionAuthenticate", async (e) => {
              try {
          ...
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ? e.logger
              : (0, sf.h6)((0, sf.iP)({ level: e?.logger || aw.logger }));
          (this.core = e?.core || new ay(e)),
            (this.logger = (0, sf.U5)(t, this.name)),
            (this.session = new az(this.core, this.logger)),
            (this.proposal = new aM(this.core, this.logger)),
            (this.pendingRequest = new aF(this.core, this.logger)),
            (this.engine = new a$(this)),
            (this.auth = new aG(this.core, this.logger));
        }
        static async init(e) {
          let t = new aQ(e);
      ...
      var aX = r(57317),
        a0 = r(81029).Buffer;
      let a1 = "error",
        a2 = "wc@2:universal_provider:",
        a8 = "https://rpc.walletconnect.org/v1/",
        a3 = "generic",
        a5 = `${a8}bundler`,
        a6 = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
      function a4() {}
      function a9(e) {
      ...
      let ci = "[object String]",
        cs = "[object Number]",
        cn = "[object Boolean]",
        co = "[object Arguments]";
      function ca(e, t, r, i = new Map(), s) {
        let n = s?.(e, t, r, i);
        if (null != n) return n;
        if (a9(e)) return e;
        ...
        if (Array.isArray(e)) {
          ...
          i.set(e, t);
          for (let n = 0; n < e.length; n++) t[n] = ca(e[n], n, r, i, s);
          return (
        ...
        if (e instanceof Map) {
          let t = new Map();
          for (let [n, o] of (i.set(e, t), e)) t.set(n, ca(o, n, r, i, s));
          return t;
        }
        if (e instanceof Set) {
          let t = new Set();
          for (let n of (i.set(e, t), e)) t.add(ca(n, void 0, r, i, s));
          return t;
        }
        if ("u" > typeof a0 && a0.isBuffer(e)) return e.subarray();
        if (a7(e)) {
        ...
        if (e instanceof DataView) {
          ...
          return i.set(e, t), cc(t, e, r, i, s), t;
        }
      ...
      function cc(e, t, r = e, i, s) {
        let n = [...Object.keys(t), ...ct(t)];
        for (let o = 0; o < n.length; o++) {
          let a = n[o],
            c = Object.getOwnPropertyDescriptor(e, a);
          (null == c || c.writable) && (e[a] = ca(t[a], a, r, i, s));
        }
      }
      function cl(e) {
        var t;
        return (
          ...
          ca(e, void 0, e, new Map(), t)
        );
      }
      function ch(e) {
        return (
          null !== e && "object" == typeof e && "[object Arguments]" === cr(e)
        );
      }
      var cu = Object.defineProperty,
        ...
        cm = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        cb = (e, t) => {
          for (var r in t || (t = {})) cg.call(t, r) && cm(e, r, t[r]);
          if (cf) for (var r of cf(t)) cy.call(t, r) && cm(e, r, t[r]);
          return e;
        },
        cw = (e, t) => cd(e, cp(t));
      function cv(e, t, r) {
        ...
        return (
          ...
          `${a8}?chainId=${s.namespace}:${s.reference}&projectId=${r}`
        );
      }
      function cE(e) {
          ...
          return (function (e, ...t) {
            ...
            for (let e = 0; e < r.length; e++)
              s = (function e(t, r, i, s) {
                if (
                  (a9(t) && (t = Object(t)), null == r || "object" != typeof r)
                )
                  return t;
                if (s.has(r))
                  return (function (e) {
                ...
                for (let o = 0; o < n.length; o++) {
                  ...
                  if (
                    (ch(c) && (c = { ...c }),
                    ch(l) && (l = { ...l }),
                    "u" > typeof a0 && a0.isBuffer(c) && (c = cl(c)),
                    Array.isArray(c))
                  )
      ...
      function cx(e) {
        ...
        for (let [a, c] of Object.entries(e)) {
          let e = iY(a) ? [a] : c.chains,
            l = c.methods || [],
            h = c.events || [],
            u = c.rpcMap || {},
            d = iZ(a);
          (o[d] = cw(cb(cb({}, o[d]), c), {
            chains: eL(e, null == (t = o[d]) ? void 0 : t.chains),
            methods: eL(l, null == (r = o[d]) ? void 0 : r.methods),
            events: eL(h, null == (i = o[d]) ? void 0 : i.events),
          })),
            (i5(u) || i5((null == (s = o[d]) ? void 0 : s.rpcMap) || {})) &&
              (o[d].rpcMap = cb(
                cb({}, u),
      ...
      function cP(e) {
        ...
        for (let [r, i] of Object.entries(e)) {
          let e = i.methods || [],
            s = i.events || [],
            n = i.accounts || [],
            o = iY(r) ? [r] : i.chains ? i.chains : cI(i.accounts);
      ...
      class cN {
        constructor(e) {
          cT(this, "name", "polkadot"),
            cT(this, "client"),
            cT(this, "httpProviders"),
            cT(this, "events"),
            cT(this, "namespace"),
            cT(this, "chainId"),
            (this.namespace = e.namespace),
            (this.events = cA("events")),
            (this.client = cA("client")),
        ...
        setDefaultChain(e, t) {
          this.httpProviders[e] || this.setHttpProvider(e, t),
            (this.chainId = e),
            this.events.emit(a6.DEFAULT_CHAIN_CHANGED, `${this.name}:${e}`);
        }
        getAccounts() {
        ...
        createHttpProvider(e, t) {
          let r = t || cv(e, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new sU.F(new aX.A(r, cA("disableProviderPing")));
        }
      }
      var cj = Object.defineProperty,
        ...
        c$ = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        cM = (e, t) => {
          for (var r in t || (t = {})) cq.call(t, r) && c$(e, r, t[r]);
          if (ck) for (var r of ck(t)) cB.call(t, r) && c$(e, r, t[r]);
          return e;
        },
        cz = (e, t) => cU(e, cL(t)),
        cF = (e, t, r) => c$(e, "symbol" != typeof t ? t + "" : t, r);
      class cH {
        constructor(e) {
          cF(this, "name", "eip155"),
            cF(this, "client"),
        ...
        createHttpProvider(e, t) {
          let r =
            t ||
            cv(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new sU.F(new aX.V(r, cA("disableProviderPing")));
        }
        setHttpProvider(e, t) {
          let r = this.createHttpProvider(e, t);
          r && (this.httpProviders[e] = r);
        ...
        async getCapabilities(e) {
          ...
          try {
            await this.client.session.update(e.topic, {
              sessionProperties: cz(cM({}, l.sessionProperties || {}), {
                capabilities: cz(cM({}, h || {}), { [c]: u }),
              }),
            });
          } catch (e) {
        ...
        async getUserOperationReceipt(e, t) {
          ...
          let i = new URL(e),
            s = await fetch(i, {
              ...
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify(
                (0, sL.formatJsonRpcRequest)("eth_getUserOperationReceipt", [
        ...
        getBundlerUrl(e, t) {
          return `${a5}?projectId=${this.client.core.projectId}&chainId=${e}&bundler=${t}`;
        }
      }
      ...
      class cX {
        constructor(e) {
          cQ(this, "name", "algorand"),
            cQ(this, "client"),
            cQ(this, "httpProviders"),
            cQ(this, "events"),
            cQ(this, "namespace"),
            cQ(this, "chainId"),
            (this.namespace = e.namespace),
        ...
        createHttpProvider(e, t) {
          ...
          return typeof r > "u"
            ? void 0
            : new sU.F(new aX.A(r, cA("disableProviderPing")));
        }
      }
      ...
      class c9 {
        constructor(e) {
          c4(this, "name", "multiversx"),
            c4(this, "client"),
            c4(this, "httpProviders"),
            c4(this, "events"),
            c4(this, "namespace"),
            c4(this, "chainId"),
            (this.namespace = e.namespace),
      ...
      class lt {
        ...
        setDefaultChain(e, t) {
          if (((this.chainId = e), !this.httpProviders[e])) {
            let r = t || cv(`${this.name}:${e}`, this.namespace);
            if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
            this.setHttpProvider(e, r);
          }
          this.events.emit(
      ...
      class ls {
        ...
        createHttpProvider(e, t) {
          let r = t || cv(e, this.namespace);
          return typeof r > "u" ? void 0 : new sU.F(new aX.A(r));
        }
      }
      ...
      var lc = Object.defineProperty,
        ...
        lf = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        lg = (e, t) => {
          for (var r in t || (t = {})) ld.call(t, r) && lf(e, r, t[r]);
          if (lu) for (var r of lu(t)) lp.call(t, r) && lf(e, r, t[r]);
          return e;
        },
        ly = (e, t) => ll(e, lh(t)),
        lm = (e, t, r) => lf(e, "symbol" != typeof t ? t + "" : t, r);
      class lb {
        constructor(e) {
          lm(this, "client"),
            lm(this, "namespaces"),
            lm(this, "optionalNamespaces"),
            lm(this, "sessionProperties"),
            lm(this, "scopedProperties"),
            lm(this, "events", new (s())()),
            lm(this, "rpcProviders", {}),
            lm(this, "session"),
            lm(this, "providerOpts"),
            lm(this, "logger"),
            lm(this, "uri"),
            lm(this, "disableProviderPing", !1),
            (this.providerOpts = e),
            (this.logger =
              "u" > typeof e?.logger && "string" != typeof e?.logger
                ? e.logger
                : (0, sf.h6)((0, sf.iP)({ level: e?.logger || a1 }))),
        ...
        sendAsync(e, t, r, i) {
          ...
          this.request(e, r, i)
            .then((e) => t(null, (0, sL.formatJsonRpcResult)(s, e)))
            .catch((e) => t(e, void 0));
        }
        async enable() {
        ...
        async authenticate(e, t) {
          ...
          if (((this.session = s.session), this.session)) {
            let e = cP(this.session.namespaces);
          ...
          if (
            ((this.client =
              ...
              (await aQ.init({
                ...
                logger: this.providerOpts.logger || a1,
                relayUrl:
        ...
        createProviders() {
          ...
          let e = [
            ...new Set(Object.keys(this.session.namespaces).map((e) => iZ(e))),
          ];
          cC("client", this.client),
            ...
            e.forEach((e) => {
              ...
              let t = (function (e, t) {
                ...
                r = cI(t),
                i = ly(
                  lg({}, c_(this.namespaces, this.optionalNamespaces)[e]),
                  { accounts: t, chains: r }
                );
              switch (e) {
                case "eip155":
                  this.rpcProviders[e] = new cH({ namespace: i });
                  break;
                case "algorand":
                  this.rpcProviders[e] = new cX({ namespace: i });
                  break;
                case "solana":
                  this.rpcProviders[e] = new cW({ namespace: i });
                  break;
                case "cosmos":
                  this.rpcProviders[e] = new cY({ namespace: i });
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new cN({ namespace: i });
                  break;
                case "cip34":
                  this.rpcProviders[e] = new c2({ namespace: i });
                  break;
                case "elrond":
                  this.rpcProviders[e] = new c5({ namespace: i });
                  break;
                case "multiversx":
                  this.rpcProviders[e] = new c9({ namespace: i });
                  break;
                case "near":
                  this.rpcProviders[e] = new lt({ namespace: i });
                  break;
                case "tezos":
                  this.rpcProviders[e] = new ls({ namespace: i });
                  break;
                default:
                  this.rpcProviders[a3]
                    ? this.rpcProviders[a3].updateNamespace(i)
                    : (this.rpcProviders[a3] = new la({ namespace: i }));
              }
            });
        }
        registerEventListeners() {
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === s.name) {
                let e = s.data;
                e && i3(e) && this.events.emit("accountsChanged", e.map(cD));
              } else if ("chainChanged" === s.name) {
                let e = r.chainId,
                  t = r.event.data,
                  i = iZ(e),
                  s = cS(e) !== cS(t) ? `${i}:${cS(t)}` : e;
            ...
            this.client.on("session_update", ({ topic: e, params: t }) => {
              ...
              (this.session = ly(lg({}, n), { namespaces: s })),
            ...
            this.client.on("session_delete", async (e) => {
              ...
              e.topic === (null == (t = this.session) ? void 0 : t.topic) &&
                ...
                this.events.emit(
                  "disconnect",
                  ly(lg({}, i8("USER_DISCONNECTED")), { data: e.topic })
                ));
            }),
            this.on(a6.DEFAULT_CHAIN_CHANGED, (e) => {
              this.onChainChanged(e, !0);
            });
        }
        getProvider(e) {
          return this.rpcProviders[e] || this.rpcProviders[a3];
        }
        onSessionUpdate() {
        ...
        setNamespaces(e) {
          ...
          (this.optionalNamespaces = c_(t, r)),
        ...
        validateChain(e) {
          ...
          if (t && r) return [t, r];
          let i = iZ(Object.keys(this.namespaces)[0]),
          ...
          try {
            ...
            let n =
              ...
              (s = null == (i = this.session) ? void 0 : i.namespaces[e])
                ...
                : s.accounts;
            if (!n) return;
            let o = n.filter((e) => e.includes(`${r}:`)).map(cD);
            if (!i3(o)) return;
        ...
        async persist(e, t) {
          ...
          await this.client.core.storage.setItem(`${a2}/${e}${i}`, t);
        }
        async getFromStore(e) {
          var t;
          let r = (null == (t = this.session) ? void 0 : t.topic) || "";
          return await this.client.core.storage.getItem(`${a2}/${e}${r}`);
        }
        async deleteFromStore(e) {
          var t;
          let r = (null == (t = this.session) ? void 0 : t.topic) || "";
          await this.client.core.storage.removeItem(`${a2}/${e}${r}`);
        }
      ...
      let lw = ["eth_sendTransaction", "personal_sign"],
        lv = [
          "eth_accounts",
          "eth_requestAccounts",
        ...
        lE = ["chainChanged", "accountsChanged"],
        lI = [
          "chainChanged",
          "accountsChanged",
          "message",
        ...
        l_ = async () => {
          let { createAppKit: e } = await r.e(6462).then(r.bind(r, 46462));
          return e;
        };
      var lx = Object.defineProperty,
        ...
        lC = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        lR = (e, t) => {
          for (var r in t || (t = {})) lO.call(t, r) && lC(e, r, t[r]);
          if (lS) for (var r of lS(t)) lA.call(t, r) && lC(e, r, t[r]);
          return e;
        },
        lT = (e, t) => lD(e, lP(t)),
        lN = (e, t, r) => lC(e, "symbol" != typeof t ? t + "" : t, r);
      function lj(e) {
      ...
      class lL {
        constructor() {
          lN(this, "events", new i.EventEmitter()),
            lN(this, "namespace", "eip155"),
            lN(this, "accounts", []),
            lN(this, "signer"),
            lN(this, "chainId", 1),
            lN(this, "modal"),
            lN(this, "rpc"),
            lN(this, "STORAGE_KEY", "wc@2:ethereum_provider:"),
            lN(this, "on", (e, t) => (this.events.on(e, t), this)),
            lN(this, "once", (e, t) => (this.events.once(e, t), this)),
            lN(
              this,
              "removeListener",
              (e, t) => (this.events.removeListener(e, t), this)
            ),
            lN(this, "off", (e, t) => (this.events.off(e, t), this)),
            lN(this, "parseAccount", (e) =>
        ...
        async connect(e) {
          ...
          let { required: r, optional: i } = (function (e) {
            ...
            if (!i3(t)) throw Error("Invalid chains");
            let c = {
                chains: t,
                methods: i || lw,
                events: n || lE,
                rpcMap: lR({}, t.length ? { [lj(t)]: a[lj(t)] } : {}),
              },
              l = n?.filter((e) => !lE.includes(e)),
              h = i?.filter((e) => !lw.includes(e));
            if (
              !r &&
              !o &&
              !s &&
            ...
            let u = {
              ...
              methods: [
                ...new Set(c.methods.concat(null != s && s.length ? s : lv)),
              ],
              events: [
                ...new Set(c.events.concat(null != o && o.length ? o : lI)),
              ],
              rpcMap: a,
            };
            return {
          ...
          try {
            let t = await new Promise(async (t, s) => {
              ...
              await this.signer
                .connect(
                  lT(
                    lR(
                      { namespaces: lR({}, r && { [this.namespace]: r }) },
            ...
            if (!t) return;
            let s = ec(t.namespaces, [this.namespace]);
          ...
          try {
            let r = await new Promise(async (r, i) => {
                ...
                this.rpc.showQrModal &&
                  ...
                  await this.signer
                    .authenticate(lT(lR({}, e), { chains: this.rpc.chains }), t)
                    .then((e) => {
                      r(e);
                    })
                    .catch((e) => {
              ...
              i = r.session;
            if (i) {
              let e = ec(i.namespaces, [this.namespace]);
        ...
        registerEventListeners() {
          this.signer.on("session_event", (e) => {
            ...
            this.signer.on("chainChanged", (e) => {
              let t = parseInt(e);
              (this.chainId = t),
                this.events.emit("chainChanged", lU(this.chainId)),
                this.persist();
            }),
        ...
        getRpcConfig(e) {
          ...
          let o = i.length ? e?.methods || lw : [],
            a = i.length ? e?.events || lE : [],
            c = e?.optionalMethods || [],
            l = e?.optionalEvents || [],
        ...
        async initialize(e) {
          if (
            ...
            (this.chainId = this.rpc.chains.length
              ? lj(this.rpc.chains)
              : lj(this.rpc.optionalChains)),
            (this.signer = await lb.init({
      ...
      var lq = Object.defineProperty,
        ...
        lH = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        lV = (e, t) => {
          for (var r in t || (t = {})) lz.call(t, r) && lH(e, r, t[r]);
          if (lM) for (var r of lM(t)) lF.call(t, r) && lH(e, r, t[r]);
          return e;
        };
      let lK = (e) => {
        let [t, r] = e.split(":");
      ...
      function lW(e) {
        return lV({ formatters: void 0, fees: void 0, serializers: void 0 }, e);
      }
      var lJ = Object.freeze({
        __proto__: null,
        convertWCMToAppKitOptions: function (e) {
          var t, r, i, s, n, o, a;
          let c = null == (t = e.chains) ? void 0 : t.map(lK).filter(Boolean);
          if (0 === c.length)
    ...
    58222: (e, t, r) => {
      "use strict";
      r.d(t, { xW: () => b, sH: () => eF, dI: () => eH });
      var i = {};
      r.r(i), r.d(i, { identity: () => A });
      var s = {};
      r.r(s), r.d(s, { base2: () => C });
      var n = {};
      r.r(n), r.d(n, { base8: () => R });
      var o = {};
      r.r(o), r.d(o, { base10: () => T });
      var a = {};
      r.r(a), r.d(a, { base16: () => N, base16upper: () => j });
      var c = {};
      r.r(c),
        r.d(c, {
          base32: () => U,
      ...
      var l = {};
      r.r(l), r.d(l, { base36: () => H, base36upper: () => V });
      var h = {};
      r.r(h), r.d(h, { base58btc: () => K, base58flickr: () => W });
      var u = {};
      r.r(u),
        r.d(u, {
          base64: () => J,
      ...
      var d = {};
      r.r(d), r.d(d, { base256emoji: () => et });
      var p = {};
      r.r(p), r.d(p, { sha256: () => ep, sha512: () => ef });
      var f = {};
      r.r(f), r.d(f, { identity: () => eg });
      var g = {};
      r.r(g),
        r.d(g, {
          code: () => em,
      ...
      let P = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new D(e, t, r, i),
        S = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: s } = w(r, t);
          return P({ prefix: e, name: t, encode: i, decode: (e) => v(s(e)) });
        },
        O = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
          P({
            prefix: t,
            name: e,
            encode: (e) =>
        ...
        C = O({ prefix: "0", name: "base2", alphabet: "01", bitsPerChar: 1 }),
        R = O({
          prefix: "7",
          name: "base8",
          alphabet: "01234567",
        ...
        T = S({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        N = O({
          prefix: "f",
          name: "base16",
          alphabet: "0123456789abcdef",
        ...
        X = Q.reduce((e, t, r) => ((e[r] = t), e), []),
        ee = Q.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []),
        et = P({
          prefix: "\uD83D\uDE80",
          name: "base256emoji",
          encode: function (e) {
            return e.reduce((e, t) => (e += X[t]), "");
          },
          decode: function (e) {
            let t = [];
            for (let r of e) {
      ...
      function er(e, t, r) {
        ...
        for (var i = (r = r || 0); e >= 0x80000000; )
          (t[r++] = (255 & e) | 128), (e /= 128);
        for (; -128 & e; ) (t[r++] = (255 & e) | 128), (e >>>= 7);
        return (t[r] = 0 | e), (er.bytes = r - i + 1), t;
      }
      function ei(e, t) {
        var r,
          i = 0,
        ...
        do {
          if (n >= o)
            throw ((ei.bytes = 0), RangeError("Could not decode varint"));
          (r = e[n++]),
            (i += s < 28 ? (127 & r) << s : (127 & r) * Math.pow(2, s)),
            (s += 7);
        } while (r >= 128);
        return (ei.bytes = n - t), i;
      }
      let es = {
          encode: er,
          decode: ei,
        ...
        en = (e, t = 0) => [es.decode(e, t), es.decode.bytes],
        eo = (e, t, r = 0) => (es.encode(e, t, r), t),
        ea = (e) => es.encodingLength(e),
        ec = (e, t) => {
          let r = t.byteLength,
            i = ea(e),
            s = i + ea(r),
            n = new Uint8Array(s + r);
          return eo(e, n, 0), eo(r, n, i), n.set(t, s), new el(e, r, t, n);
        };
      class el {
        constructor(e, t, r, i) {
          (this.code = e), (this.size = t), (this.digest = r), (this.bytes = i);
      ...
      let eh = ({ name: e, code: t, encode: r }) => new eu(e, t, r);
      class eu {
        constructor(e, t, r) {
          (this.name = e), (this.code = t), (this.encode = r);
        }
      ...
      let ed = (e) => async (t) =>
          new Uint8Array(await crypto.subtle.digest(e, t)),
        ep = eh({ name: "sha2-256", code: 18, encode: ed("SHA-256") }),
        ef = eh({ name: "sha2-512", code: 19, encode: ed("SHA-512") }),
        eg = {
          code: 0,
          name: "identity",
          encode: v,
        ...
        eI = "json",
        e_ = 512,
        ex = (e) => ev.encode(JSON.stringify(e)),
      ...
      class eP {
        ...
        toString(e) {
          ...
          return 0 === r ? eO(t, i, e || K.encoder) : eA(t, i, e || U.encoder);
        }
        toJSON() {
          return {
            code: this.code,
        ...
        static isCID(e) {
          return eL(/^0\.0/, ek), !!(e && (e[eN] || e.asCID === e));
        }
        ...
        static asCID(e) {
          ...
          if (null != e && e.asCID === e) {
            ...
            return new eP(t, r, i, s || eT(t, r, i.bytes));
          }
        ...
        static create(e, t, r) {
          ...
          switch (e) {
            case 0:
              if (t === eC) return new eP(e, t, r, r.bytes);
              throw Error(
                `Version 0 CID must use dag-pb (code: ${eC}) block encoding`
              );
            case 1: {
        ...
        static decodeFirst(e) {
          ...
          let s = i.subarray(t.multihashSize - t.digestSize),
            n = new el(t.multihashCode, t.digestSize, s, i);
          return [
            0 === t.version ? eP.createV0(n) : eP.createV1(t.codec, n),
            e.subarray(t.size),
          ];
        }
      ...
      let eS = (e, t) => {
          switch (e[0]) {
            case "Q": {
              let r = t || K;
              return [K.prefix, r.decode(`${K.prefix}${e}`)];
            }
            case K.prefix: {
              let r = t || K;
        ...
        eT = (e, t, r) => {
          ...
          return eo(e, n, 0), eo(t, n, i), n.set(r, s), n;
        },
        ...
        ek = `CID.isCID(v) is deprecated and will be removed in the next major release.
